import { Component, OnInit, ViewChild, HostBinding, ChangeDetectionStrategy, ViewEncapsulation,Output,EventEmitter } from '@angular/core';
import { Wtf2TableDataSource, Wtf2Paginator, Wtf2Sort, Wtf2Row } from '@wtf2/theme/wtf2-material';
...
export class GridCheckboxComponent implements OnInit {
  ...
  MyDataSource: any;
  displayedColumns = ['select', 'id', 'userId', 'title', 'completed', 'star'];
