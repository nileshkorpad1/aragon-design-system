...
import { Wtf2TreeFlattener, Wtf2TreeFlatDataSource } from '@wtf2/theme/wtf2-material';
...
@Component({
  selector: 'app-tree-partially',
  templateUrl: './tree-partially.component.html',
  styleUrls: ['./tree-partially.component.scss'],
  providers: [LoadmoreDatabase],
})
export class TreePartiallyComponent implements OnInit {

  nodeMap = new Map<string, LoadmoreFlatNode>();
  treeControl: FlatTreeControl<LoadmoreFlatNode>;
  treeFlattener: Wtf2TreeFlattener<LoadmoreNode, LoadmoreFlatNode>;
  // Flat tree data source
  dataSource: Wtf2TreeFlatDataSource<LoadmoreNode, LoadmoreFlatNode>;

  constructor(private database: LoadmoreDatabase) {
    this.treeFlattener = new Wtf2TreeFlattener(this.transformer, this.getLevel,
