...
import { Wtf2PasswordAuthStrategy } from './password-strategy';
import { Wtf2AuthResult } from '../../services/auth-result';

import { HttpClientTestingModule, HttpTestingController } from '@angular/common/http/testing';
import { RouterTestingModule } from '@angular/router/testing';
import { HttpErrorResponse, HttpResponse } from '@angular/common/http';
import { wtf2AuthCreateToken, Wtf2AuthSimpleToken } from '../../services';

const ownerStrategyName = 'strategy';

describe('password-auth-strategy', () => {

  let strategy: Wtf2PasswordAuthStrategy;
  ...
  const successToken = wtf2AuthCreateToken(Wtf2AuthSimpleToken, 'token', ownerStrategyName);
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: Wtf2PasswordAuthStrategy, useClass: Wtf2PasswordAuthStrategy },
      ],
    });
  });

  beforeEach(async(inject(
    [Wtf2PasswordAuthStrategy, HttpTestingController],
    (_strategy, _httpMock) => {
      strategy = _strategy;
      httpMock = _httpMock;
