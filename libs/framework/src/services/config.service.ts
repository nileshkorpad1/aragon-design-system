...
export const WTF2_CONFIG = new InjectionToken('wtf2CustomConfig');

@Injectable({
    providedIn: 'root',
})
export class Wtf2ConfigService {
    // Private
    ...
    constructor(
        ...
        @Inject(WTF2_CONFIG) private _config,
    ) {
    ...
    private _init(): void {
         ...
         */
        this._defaultConfig.wtf2theme = 'default';
