...
import {Wtf2Ripple, defaultRippleAnimationConfig, ThemePalette} from '../core';
import {By} from '@angular/platform-browser';
import {
  Wtf2ListModule,
  Wtf2ListOption,
  Wtf2SelectionList,
  Wtf2SelectionListChange
} from './index';
import {FormControl, FormsModule, NgModel, ReactiveFormsModule} from '@angular/forms';

describe('Wtf2SelectionList without forms', () => {
  describe('with list option', () => {
    ...
    beforeEach(async(() => {
      ...
      listOptions = fixture.debugElement.queryAll(By.directive(Wtf2ListOption));
      selectionList = fixture.debugElement.query(By.directive(Wtf2SelectionList));
    }));
    ...
    it('should not emit a selectionChange event if an option changed programwtf2ically', () => {
    ...
    it('should be able to dispatch one selected item', () => {
      let testListItem = listOptions[2].injector.get<Wtf2ListOption>(Wtf2ListOption);
      let selectList =
          selectionList.injector.get<Wtf2SelectionList>(Wtf2SelectionList).selectedOptions;
    ...
    it('should be able to dispatch multiple selected items', () => {
      let testListItem = listOptions[2].injector.get<Wtf2ListOption>(Wtf2ListOption);
      let testListItem2 = listOptions[1].injector.get<Wtf2ListOption>(Wtf2ListOption);
      let selectList =
          selectionList.injector.get<Wtf2SelectionList>(Wtf2SelectionList).selectedOptions;
    ...
    it('should be able to specify a color for list options', () => {
      ...
      expect(optionNativeElements.every(option => !option.classList.contains('wtf2-primary')))
        .toBe(true);
      expect(optionNativeElements.every(option => !option.classList.contains('wtf2-warn')))
        .toBe(true);
      ...
      expect(optionNativeElements[0].classList).toContain('wtf2-primary');
      expect(optionNativeElements[0].classList).not.toContain('wtf2-warn');
      expect(optionNativeElements.slice(1).every(option => option.classList.contains('wtf2-warn')))
        .toBe(true);
    });
    ...
    it('should not allow selection of disabled items', () => {
      let testListItem = listOptions[0].injector.get<Wtf2ListOption>(Wtf2ListOption);
      let selectList =
          selectionList.injector.get<Wtf2SelectionList>(Wtf2SelectionList).selectedOptions;
    ...
    it('should be able to select all options', () => {
      const list: Wtf2SelectionList = selectionList.componentInstance;
    ...
    it('should update the list value when an item is selected programwtf2ically', () => {
      const list: Wtf2SelectionList = selectionList.componentInstance;
    ...
    it('should update the item selected state when it is selected via the model', () => {
      const list: Wtf2SelectionList = selectionList.componentInstance;
      const item: Wtf2ListOption = listOptions[0].componentInstance;
    ...
    it('should be able to reach list options that are indirect descendants', () => {
      ...
      listOptions = descendatsFixture.debugElement.queryAll(By.directive(Wtf2ListOption));
      selectionList = descendatsFixture.debugElement.query(By.directive(Wtf2SelectionList));
      const list: Wtf2SelectionList = selectionList.componentInstance;
    ...
    it('should disable list item ripples when the ripples on the list have been disabled',
      fakeAsync(() => {
        const rippleTarget = fixture.nativeElement
            .querySelector('.wtf2-list-option:not(.wtf2-list-item-disabled) .wtf2-list-item-content');
  ...
  describe('with list option selected', () => {
    ...
    beforeEach(async(() => {
      ...
      listItemEl = fixture.debugElement.query(By.directive(Wtf2ListOption));
      selectionList = fixture.debugElement.query(By.directive(Wtf2SelectionList));
      fixture.detectChanges();
    }));

    it('should set its initial selected state in the selectedOptions', () => {
      let optionEl = listItemEl.injector.get<Wtf2ListOption>(Wtf2ListOption);
  ...
  describe('with tabindex', () => {
    ...
    it('should properly handle native tabindex attribute', () => {
      ...
      const selectionList = fixture.debugElement.query(By.directive(Wtf2SelectionList));
  ...
  describe('with option disabled', () => {
    ...
    beforeEach(async(() => {
      ...
      const listOptionDebug = fixture.debugElement.query(By.directive(Wtf2ListOption));
    ...
    it('should apply the "wtf2-list-item-disabled" class properly', () => {
      expect(listOptionEl.classList).not.toContain('wtf2-list-item-disabled');

      fixture.componentInstance.disableItem = true;
      fixture.detectChanges();

      expect(listOptionEl.classList).toContain('wtf2-list-item-disabled');
    });
  });
  ...
  describe('with list disabled', () => {
    ...
    beforeEach(async(() => {
      ...
      listOption = fixture.debugElement.queryAll(By.directive(Wtf2ListOption));
      selectionList = fixture.debugElement.query(By.directive(Wtf2SelectionList));
      fixture.detectChanges();
    }));

    it('should not allow selection on disabled selection-list', () => {
      let testListItem = listOption[2].injector.get<Wtf2ListOption>(Wtf2ListOption);
      let selectList =
          selectionList.injector.get<Wtf2SelectionList>(Wtf2SelectionList).selectedOptions;
    ...
    it('should update state of options if list state has changed', () => {
      ...
      const listOptionRipple = listOption[2].query(By.directive(Wtf2Ripple))
          .injector.get<Wtf2Ripple>(Wtf2Ripple);
  ...
  describe('with checkbox position after', () => {
    ...
    it('should be able to customize checkbox position', () => {
      let listItemContent = fixture.debugElement.query(By.css('.wtf2-list-item-content'));
      expect(listItemContent.nativeElement.classList).toContain('wtf2-list-item-content-reverse');
    });
  });
  ...
  describe('with list item elements', () => {
    ...
    it('should add a class to reflect that it has an avatar', () => {
      ...
      const listOption = fixture.nativeElement.querySelector('.wtf2-list-option');
      expect(listOption.classList).toContain('wtf2-list-item-with-avatar');
    });
...
describe('Wtf2SelectionList with forms', () => {

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2ListModule, FormsModule, ReactiveFormsModule],
      declarations: [
  ...
  describe('and ngModel', () => {
    ...
    let listOptions: Wtf2ListOption[];
    let ngModel: NgModel;
    ...
    beforeEach(() => {
      ...
      selectionListDebug = fixture.debugElement.query(By.directive(Wtf2SelectionList));
      ngModel = selectionListDebug.injector.get<NgModel>(NgModel);
      listOptions = fixture.debugElement.queryAll(By.directive(Wtf2ListOption))
        .map(optionDebugEl => optionDebugEl.componentInstance);
    });

    it('should update the model if an option got selected programwtf2ically', fakeAsync(() => {
    ...
    it('should be pristine by default', fakeAsync(() => {
      ...
      ngModel =
        fixture.debugElement.query(By.directive(Wtf2SelectionList)).injector.get<NgModel>(NgModel);
      listOptions = fixture.debugElement.queryAll(By.directive(Wtf2ListOption))
        .map(optionDebugEl => optionDebugEl.componentInstance);
    ...
    it('should be able to programwtf2ically set an array with duplicate values', fakeAsync(() => {
  ...
  describe('and formControl', () => {
    ...
    let listOptions: Wtf2ListOption[];
    let selectionList: Wtf2SelectionList;

    beforeEach(() => {
      fixture = TestBed.createComponent(SelectionListWithFormControl);
      fixture.detectChanges();

      selectionList = fixture.debugElement.query(By.directive(Wtf2SelectionList)).componentInstance;
      listOptions = fixture.debugElement.queryAll(By.directive(Wtf2ListOption))
        .map(optionDebugEl => optionDebugEl.componentInstance);
    });
  ...
  describe('preselected values', () => {
    it('should add preselected options to the model value', fakeAsync(() => {
      ...
      const listOptions = fixture.debugElement.queryAll(By.directive(Wtf2ListOption))
          .map(optionDebugEl => optionDebugEl.componentInstance);
    ...
    it('should show the item as selected when preselected inside OnPush parent', fakeAsync(() => {
      ...
      const option = fixture.debugElement.queryAll(By.directive(Wtf2ListOption))[1];
      ...
      expect(option.nativeElement.querySelector('.wtf2-pseudo-checkbox-checked')).toBeTruthy();
    }));
...
@Component({template: `
  <wtf2-selection-list
    ...
    <wtf2-list-option checkboxPosition="before" disabled="true" value="inbox"
                     [color]="firstOptionColor">
      Inbox (disabled selection-option)
    </wtf2-list-option>
    <wtf2-list-option id="testSelect" checkboxPosition="before" class="test-native-focus"
                    value="starred">
      Starred
    </wtf2-list-option>
    <wtf2-list-option checkboxPosition="before" value="sent-mail">
      Sent Mail
    </wtf2-list-option>
    <wtf2-list-option checkboxPosition="before" value="drafts" *ngIf="showLastOption">
      Drafts
    </wtf2-list-option>
  </wtf2-selection-list>`})
class SelectionListWithListOptions {
  ...
  onValueChange(_change: Wtf2SelectionListChange) {}
}

@Component({template: `
  <wtf2-selection-list id="selection-list-2">
    <wtf2-list-option checkboxPosition="after">
      Inbox (disabled selection-option)
    </wtf2-list-option>
    <wtf2-list-option id="testSelect" checkboxPosition="after">
      Starred
    </wtf2-list-option>
    <wtf2-list-option checkboxPosition="after">
      Sent Mail
...
@Component({template: `
  <wtf2-selection-list id="selection-list-3" [disabled]="disabled">
    <wtf2-list-option checkboxPosition="after">
      Inbox (disabled selection-option)
    </wtf2-list-option>
    <wtf2-list-option id="testSelect" checkboxPosition="after">
...
@Component({template: `
  <wtf2-selection-list>
    <wtf2-list-option [disabled]="disableItem">Item</wtf2-list-option>
  </wtf2-selection-list>
  `})
...
@Component({template: `
  <wtf2-selection-list>
    <wtf2-list-option [selected]="true">Item</wtf2-list-option>
  </wtf2-selection-list>`})
class SelectionListWithSelectedOption {
}

@Component({template: `
  <wtf2-selection-list id="selection-list-4">
    <wtf2-list-option checkboxPosition="after" class="test-focus" id="123">
      Inbox
    </wtf2-list-option>
  </wtf2-selection-list>`})
...
@Component({
  template: `<wtf2-selection-list tabindex="5"></wtf2-selection-list>`
})
class SelectionListWithTabindexAttr {}

@Component({
  template: `<wtf2-selection-list [tabIndex]="tabIndex" [disabled]="disabled"></wtf2-selection-list>`
})
...
@Component({
  template: `
    <wtf2-selection-list [(ngModel)]="selectedOptions" (ngModelChange)="modelChangeSpy()">
      <wtf2-list-option *ngFor="let option of options" [value]="option">{{option}}</wtf2-list-option>
    </wtf2-selection-list>`
})
...
@Component({
  template: `
    <wtf2-selection-list [formControl]="formControl" *ngIf="renderList">
      <wtf2-list-option value="opt1">Option 1</wtf2-list-option>
      <wtf2-list-option value="opt2">Option 2</wtf2-list-option>
      <wtf2-list-option value="opt3">Option 3</wtf2-list-option>
    </wtf2-selection-list>
  `
})
...
@Component({
  template: `
    <wtf2-selection-list [(ngModel)]="selectedOptions">
      <wtf2-list-option value="opt1">Option 1</wtf2-list-option>
      <wtf2-list-option value="opt2" selected>Option 2</wtf2-list-option>
    </wtf2-selection-list>`
})
...
@Component({
  ...
  template: `
    <wtf2-selection-list [formControl]="formControl">
      <wtf2-list-option *ngFor="let opt of opts" [value]="opt">{{opt}}</wtf2-list-option>
    </wtf2-selection-list>
  `
})
...
@Component({
  template: `
    <wtf2-selection-list [(ngModel)]="selectedOptions" [compareWith]="compareWith">
      <wtf2-list-option *ngFor="let option of options" [value]="option">
        {{option.label}}
      </wtf2-list-option>
    </wtf2-selection-list>`
})
class SelectionListWithCustomComparator {
  @ViewChildren(Wtf2ListOption) optionInstances: QueryList<Wtf2ListOption>;
  ...
  template: `
    <wtf2-selection-list>
      <ng-container [ngSwitch]="true">
        <wtf2-list-option [value]="1">One</wtf2-list-option>
        <wtf2-list-option [value]="2">Two</wtf2-list-option>
      </ng-container>
    </wtf2-selection-list>`
})
