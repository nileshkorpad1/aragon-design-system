...
describe('Wtf2MonthView', () => {
  ...
  describe('standard month view', () => {
    ...
    beforeEach(() => {
      ...
      let monthViewDebugElement = fixture.debugElement.query(By.directive(Wtf2MonthView));
      monthViewNativeElement = monthViewDebugElement.nativeElement;
      testComponent = fixture.componentInstance;
    });

    it('has correct month label', () => {
      let labelEl = monthViewNativeElement.querySelector('.wtf2-calendar-body-label')!;
      expect(labelEl.innerHTML.trim()).toBe('JAN');
    });

    it('has 31 days', () => {
      let cellEls = monthViewNativeElement.querySelectorAll('.wtf2-calendar-body-cell')!;
      expect(cellEls.length).toBe(31);
    });

    it('shows selected date if in same month', () => {
      let selectedEl = monthViewNativeElement.querySelector('.wtf2-calendar-body-selected')!;
    ...
    it('should mark active date', () => {
      ...
      expect(cellEls[4].classList).toContain('wtf2-calendar-body-active');
    });
  ...
  describe('month view with date filter', () => {
    ...
    it('should disable filtered dates', () => {
      let cells = monthViewNativeElement.querySelectorAll('.wtf2-calendar-body-cell');
...
@Component({
  template: `<wtf2-month-view [(activeDate)]="date" [(selected)]="selected"></wtf2-month-view>`,
})
...
@Component({
  template: `<wtf2-month-view [activeDate]="activeDate" [dateFilter]="dateFilter"></wtf2-month-view>`
})
...
@Component({
  template: `<wtf2-month-view [activeDate]="activeDate" [dateClass]="dateClass"></wtf2-month-view>`
})
