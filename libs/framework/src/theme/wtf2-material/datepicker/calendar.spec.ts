...
import {DateAdapter, Wtf2NativeDateModule} from '../core';
...
describe('Wtf2Calendar', () => {
  ...
  describe('standard calendar', () => {
    ...
    it(`should update today's date`, inject([DateAdapter], (adapter: DateAdapter<Date>) => {
      ...
      let todayCell = calendarElement.querySelector('.wtf2-calendar-body-today')!;
      ...
      todayCell = calendarElement.querySelector('.wtf2-calendar-body-today')!;
      expect(todayCell).not.toBeNull();
    ...
    it('should re-render when the i18n labels have changed',
      inject([Wtf2DatepickerIntl], (intl: Wtf2DatepickerIntl) => {
        const button = fixture.debugElement.nativeElement
            .querySelector('.wtf2-calendar-period-button');
    ...
    describe('a11y', () => {
      describe('calendar body', () => {
        ...
        beforeEach(() => {
          calendarBodyEl = calendarElement.querySelector('.wtf2-calendar-content') as HTMLElement;
        ...
        it('should not move focus to the active cell on init', () => {
          const activeCell =
              calendarBodyEl.querySelector('.wtf2-calendar-body-active')! as HTMLElement;
        ...
        describe('year view', () => {
          beforeEach(() => {
            ...
            (calendarBodyEl.querySelector('.wtf2-calendar-body-active') as HTMLElement).click();
            fixture.detectChanges();
          ...
          it('should return to month view on enter', () => {
            const tableBodyEl = calendarBodyEl.querySelector('.wtf2-calendar-body') as HTMLElement;
  ...
  describe('calendar with min and max date', () => {
    ...
    it('should not go back past min date', () => {
      ...
      let prevButton =
          calendarElement.querySelector('.wtf2-calendar-previous-button') as HTMLButtonElement;
    ...
    it('should not go forward past max date', () => {
      ...
      let nextButton =
          calendarElement.querySelector('.wtf2-calendar-next-button') as HTMLButtonElement;
    ...
    it('should re-render the year view when the minDate changes', () => {
      fixture.detectChanges();
      const periodButton =
          calendarElement.querySelector('.wtf2-calendar-period-button') as HTMLElement;
      periodButton.click();
      fixture.detectChanges();
    ...
    it('should update the minDate in the child view if it changed after an interaction', () => {
      ...
      const calendarDebugElement = dynamicFixture.debugElement.query(By.directive(Wtf2Calendar));
      const disabledClass = 'wtf2-calendar-body-disabled';
      calendarElement = calendarDebugElement.nativeElement;
      calendarInstance = calendarDebugElement.componentInstance;

      let cells = Array.from(calendarElement.querySelectorAll('.wtf2-calendar-body-cell'));
      ...
      dynamicFixture.detectChanges();
      cells = Array.from(calendarElement.querySelectorAll('.wtf2-calendar-body-cell'));
  ...
  describe('calendar with date filter', () => {
    ...
    it('should disable and prevent selection of filtered dates', () => {
      let cells = calendarElement.querySelectorAll('.wtf2-calendar-body-cell');
    ...
    describe('a11y', () => {
      ...
      beforeEach(() => {
        tableBodyEl = calendarElement.querySelector('.wtf2-calendar-body') as HTMLElement;
...
@Component({
  template: `
    <wtf2-calendar [startAt]="startAt" [minDate]="minDate" [maxDate]="maxDate"></wtf2-calendar>
  `
})
...
@Component({
  template: `
    <wtf2-calendar [startAt]="startDate" [(selected)]="selected" [dateFilter]="dateFilter">
    </wtf2-calendar>
  `
})
