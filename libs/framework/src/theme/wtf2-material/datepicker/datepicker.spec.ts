...
import {WTF2_DATE_LOCALE, Wtf2NativeDateModule, NativeDateModule} from '../core';
...
import {Wtf2DatepickerToggle} from './datepicker-toggle';
import {WTF2_DATEPICKER_SCROLL_STRATEGY, Wtf2DatepickerIntl, Wtf2DatepickerModule} from './index';

describe('Wtf2Datepicker', () => {
  ...
  describe('with Wtf2NativeDateModule', () => {
    describe('standard datepicker', () => {
      let fixture: ComponentFixture<StandardDatepicker>;
      let testComponent: StandardDatepicker;

      beforeEach(fakeAsync(() => {
        fixture = createComponent(StandardDatepicker, [Wtf2NativeDateModule]);
      ...
      it('open non-touch should open popup', () => {
        expect(document.querySelector('.cdk-overlay-pane.wtf2-datepicker-popup')).toBeNull();

        testComponent.datepicker.open();
        fixture.detectChanges();

        expect(document.querySelector('.cdk-overlay-pane.wtf2-datepicker-popup')).not.toBeNull();
      });
      ...
      it('touch should open dialog', () => {
        ...
        expect(document.querySelector('.wtf2-datepicker-dialog wtf2-dialog-container')).toBeNull();

        testComponent.datepicker.open();
        fixture.detectChanges();

        expect(document.querySelector('.wtf2-datepicker-dialog wtf2-dialog-container'))
            .not.toBeNull();
      });
      ...
      it('should not be able to open more than one dialog', fakeAsync(() => {
        ...
        expect(document.querySelectorAll('.wtf2-datepicker-dialog').length).toBe(0);
        ...
        dispatchKeyboardEvent(document.querySelector('.wtf2-calendar-body')!, 'keydown', ENTER);
        fixture.detectChanges();
        tick(100);
        ...
        expect(document.querySelectorAll('.wtf2-datepicker-dialog').length).toBe(1);
      }));
      ...
      it('should open datepicker if opened input is set to true', fakeAsync(() => {
        ...
        expect(document.querySelector('.wtf2-datepicker-content')).not.toBeNull();

        testComponent.opened = false;
        fixture.detectChanges();
        flush();

        expect(document.querySelector('.wtf2-datepicker-content')).toBeNull();
      }));
      ...
      it('open in disabled mode should not open the calendar', () => {
        ...
        expect(document.querySelector('wtf2-dialog-container')).toBeNull();
      ...
      it('close should close dialog', fakeAsync(() => {
        ...
        expect(document.querySelector('wtf2-dialog-container')).not.toBeNull();
      ...
      it('setting selected via click should update input and close calendar', fakeAsync(() => {
        ...
        let cells = document.querySelectorAll('.wtf2-calendar-body-cell');
      ...
      it('setting selected via enter press should update input and close calendar',
        fakeAsync(() => {
          ...
          let calendarBodyEl = document.querySelector('.wtf2-calendar-body') as HTMLElement;
      ...
      it('input should aria-owns calendar after opened in non-touch mode', fakeAsync(() => {
        ...
        expect((ownedElement as Element).tagName.toLowerCase()).toBe('wtf2-calendar');
      }));
      ...
      it('should reset the datepicker when it is closed externally',
        fakeAsync(inject([OverlayContainer], (oldOverlayContainer: OverlayContainer) => {
          ...
          fixture = createComponent(StandardDatepicker, [Wtf2NativeDateModule], [
            ...
            {
              provide: WTF2_DATEPICKER_SCROLL_STRATEGY,
              deps: [Overlay],
    ...
    describe('datepicker with too many inputs', () => {
      it('should throw when multiple inputs registered', fakeAsync(() => {
        const fixture = createComponent(MultiInputDatepicker, [Wtf2NativeDateModule]);
    ...
    describe('datepicker that is assigned to input at a later point', () => {
      it('should not throw on ALT + DOWN_ARROW for input without datepicker', fakeAsync(() => {
        const fixture = createComponent(DelayedDatepicker, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with no inputs', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(NoInputDatepicker, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with startAt', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithStartAt, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with startView set to year', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithStartViewYear, [Wtf2NativeDateModule]);
        fixture.detectChanges();
      ...
      it('should start at the specified view', () => {
        ...
        const firstCalendarCell = document.querySelector('.wtf2-calendar-body-cell')!;
      ...
      it('should fire yearSelected when user selects calendar year in year view',
        fakeAsync(() => {
          ...
          const cells = document.querySelectorAll('.wtf2-calendar-body-cell');
    ...
    describe('datepicker with startView set to multiyear', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithStartViewMultiYear, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with ngModel', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithNgModel, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with formControl', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithFormControl, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with wtf2-datepicker-toggle', () => {
      let fixture: ComponentFixture<DatepickerWithToggle>;
      let testComponent: DatepickerWithToggle;

      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithToggle, [Wtf2NativeDateModule]);
        fixture.detectChanges();
      ...
      it('should re-render when the i18n labels change',
        inject([Wtf2DatepickerIntl], (intl: Wtf2DatepickerIntl) => {
          const toggle = fixture.debugElement.query(By.css('button')).nativeElement;
      ...
      it('should toggle the active state of the datepicker toggle', fakeAsync(() => {
        const toggle = fixture.debugElement.query(By.css('wtf2-datepicker-toggle')).nativeElement;

        expect(toggle.classList).not.toContain('wtf2-datepicker-toggle-active');

        fixture.componentInstance.datepicker.open();
        fixture.detectChanges();
        flush();

        expect(toggle.classList).toContain('wtf2-datepicker-toggle-active');
    ...
    describe('datepicker with custom wtf2-datepicker-toggle icon', () => {
      it('should be able to override the wtf2-datepicker-toggle icon', fakeAsync(() => {
        const fixture = createComponent(DatepickerWithCustomIcon, [Wtf2NativeDateModule]);
        fixture.detectChanges();

        expect(fixture.nativeElement.querySelector('.wtf2-datepicker-toggle .custom-icon'))
            .toBeTruthy('Expected custom icon to be rendered.');

        expect(fixture.nativeElement.querySelector('.wtf2-datepicker-toggle wtf2-icon'))
            .toBeFalsy('Expected default icon to be removed.');
      }));
    });

    describe('datepicker with tabindex on wtf2-datepicker-toggle', () => {
      it('should forward the tabindex to the underlying button', () => {
        const fixture = createComponent(DatepickerWithTabindexOnToggle, [Wtf2NativeDateModule]);
        fixture.detectChanges();

        const button = fixture.nativeElement.querySelector('.wtf2-datepicker-toggle button');

        expect(button.getAttribute('tabindex')).toBe('7');
      });

      it('should clear the tabindex from the wtf2-datepicker-toggle host', () => {
        const fixture = createComponent(DatepickerWithTabindexOnToggle, [Wtf2NativeDateModule]);
        fixture.detectChanges();

        const host = fixture.nativeElement.querySelector('.wtf2-datepicker-toggle');
    ...
    describe('datepicker inside wtf2-form-field', () => {
      let fixture: ComponentFixture<FormFieldDatepicker>;
      let testComponent: FormFieldDatepicker;

      beforeEach(fakeAsync(() => {
        fixture = createComponent(FormFieldDatepicker, [Wtf2NativeDateModule]);
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
      }));
      ...
      it('should float the placeholder when an invalid value is entered', () => {
        ...
        expect(fixture.debugElement.nativeElement.querySelector('wtf2-form-field').classList)
          .toContain('wtf2-form-field-should-float');
      });
      ...
      it('should pass the form field theme color to the overlay', fakeAsync(() => {
        ...
        let contentEl = document.querySelector('.wtf2-datepicker-content')!;

        expect(contentEl.classList).toContain('wtf2-primary');
        ...
        contentEl = document.querySelector('.wtf2-datepicker-content')!;
        fixture.detectChanges();
        flush();

        expect(contentEl.classList).toContain('wtf2-warn');
        expect(contentEl.classList).not.toContain('wtf2-primary');
      }));
      ...
      it('should prefer the datepicker color over the form field one', fakeAsync(() => {
        ...
        const contentEl = document.querySelector('.wtf2-datepicker-content')!;

        expect(contentEl.classList).toContain('wtf2-accent');
        expect(contentEl.classList).not.toContain('wtf2-warn');
      }));
    });
    ...
    describe('datepicker with min and max dates and validation', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithMinAndMaxValidation, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('datepicker with filter and validation', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithFilterAndValidation, [Wtf2NativeDateModule]);
        fixture.detectChanges();
      ...
      it('should disable filtered calendar cells', () => {
        ...
        let cells = document.querySelectorAll('.wtf2-calendar-body-cell');
        expect(cells[0].classList).toContain('wtf2-calendar-body-disabled');
        expect(cells[1].classList).not.toContain('wtf2-calendar-body-disabled');
      });
    });
    ...
    describe('datepicker with change and input events', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithChangeAndInputEvents, [Wtf2NativeDateModule]);
        fixture.detectChanges();
    ...
    describe('with ISO 8601 strings as input', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithISOStrings, [Wtf2NativeDateModule]);
        testComponent = fixture.componentInstance;
      }));
    ...
    describe('with events', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerWithEvents, [Wtf2NativeDateModule]);
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
      }));
    ...
    describe('datepicker that opens on focus', () => {
      ...
      beforeEach(fakeAsync(() => {
        fixture = createComponent(DatepickerOpeningOnFocus, [Wtf2NativeDateModule]);
        fixture.detectChanges();
        testComponent = fixture.componentInstance;
    ...
    describe('datepicker directionality', () => {
      it('should pass along the directionality to the popup', () => {
        const fixture = createComponent(StandardDatepicker, [Wtf2NativeDateModule], [{
  ...
  describe('with missing DateAdapter and WTF2_DATE_FORMATS', () => {
    it('should throw when created', () => {
      expect(() => createComponent(StandardDatepicker))
        .toThrowError(/Wtf2Datepicker: No provider found for .*/);
    });
  });
  ...
  describe('datepicker toggle without a datepicker', () => {
    it('should not throw on init if toggle does not have a datepicker', () => {
      expect(() => {
        const fixture = createComponent(DatepickerToggleWithNoDatepicker, [Wtf2NativeDateModule]);
        fixture.detectChanges();
      }).not.toThrow();
    });
  });
  ...
  describe('internationalization', () => {
    ...
    beforeEach(fakeAsync(() => {
      fixture = createComponent(DatepickerWithi18n, [Wtf2NativeDateModule, NativeDateModule],
        [{provide: WTF2_DATE_LOCALE, useValue: 'de-DE'}]);
      fixture.detectChanges();
      testComponent = fixture.componentInstance;
  ...
  describe('datepicker with custom header', () => {
    ...
    it('should find the standard header element', fakeAsync(() => {
      ...
      expect(document.querySelector('wtf2-calendar-header')).toBeTruthy();
    }));
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [value]="date">
    <wtf2-datepicker #d [touchUi]="touch" [disabled]="disabled" [opened]="opened"></wtf2-datepicker>
  `,
})
class StandardDatepicker {
  ...
  @ViewChild('d', {static: false}) datepicker: Wtf2Datepicker<Date>;
  @ViewChild(Wtf2DatepickerInput, {static: false}) datepickerInput: Wtf2DatepickerInput<Date>;
}


@Component({
  template: `
    <input [wtf2Datepicker]="d"><input [wtf2Datepicker]="d"><wtf2-datepicker #d></wtf2-datepicker>
  `,
})
...
@Component({
  template: `<wtf2-datepicker #d></wtf2-datepicker>`,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [value]="date">
    <wtf2-datepicker #d [startAt]="startDate"></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [value]="date">
    <wtf2-datepicker #d startView="year" (monthSelected)="onYearSelection()"></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [value]="date">
    <wtf2-datepicker #d startView="multi-year"
        (yearSelected)="onMultiYearSelection()"></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input [(ngModel)]="selected" [wtf2Datepicker]="d">
    <wtf2-datepicker #d></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input [formControl]="formControl" [wtf2Datepicker]="d">
    <wtf2-datepicker-toggle [for]="d"></wtf2-datepicker-toggle>
    <wtf2-datepicker #d></wtf2-datepicker>
  `,
})
class DatepickerWithFormControl {
  ...
  @ViewChild('d', {static: false}) datepicker: Wtf2Datepicker<Date>;
  @ViewChild(Wtf2DatepickerInput, {static: false}) datepickerInput: Wtf2DatepickerInput<Date>;
  @ViewChild(Wtf2DatepickerToggle, {static: false}) datepickerToggle: Wtf2DatepickerToggle<Date>;
}


@Component({
  template: `
    <input [wtf2Datepicker]="d">
    <wtf2-datepicker-toggle [for]="d"></wtf2-datepicker-toggle>
    <wtf2-datepicker #d [touchUi]="touchUI"></wtf2-datepicker>
  `,
})
class DatepickerWithToggle {
  @ViewChild('d', {static: false}) datepicker: Wtf2Datepicker<Date>;
  @ViewChild(Wtf2DatepickerInput, {static: false}) input: Wtf2DatepickerInput<Date>;
  touchUI = true;
}
...
@Component({
  template: `
    <input [wtf2Datepicker]="d">
    <wtf2-datepicker-toggle [for]="d">
      <div class="custom-icon" wtf2DatepickerToggleIcon></div>
...
@Component({
  template: `
      <wtf2-form-field>
        <input wtf2Input [wtf2Datepicker]="d">
        <wtf2-datepicker #d></wtf2-datepicker>
      </wtf2-form-field>
  `,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [(ngModel)]="date" [min]="minDate" [max]="maxDate">
    <wtf2-datepicker-toggle [for]="d"></wtf2-datepicker-toggle>
    <wtf2-datepicker #d></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [(ngModel)]="date" [wtf2DatepickerFilter]="filter">
    <wtf2-datepicker-toggle [for]="d"></wtf2-datepicker-toggle>
    <wtf2-datepicker #d [touchUi]="true"></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" (change)="onChange()" (input)="onInput()"
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [(ngModel)]="date">
    <wtf2-datepicker #d></wtf2-datepicker>
  `
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="d" [(ngModel)]="value" [min]="min" [max]="max">
    <wtf2-datepicker #d [startAt]="startAt"></wtf2-datepicker>
  `
})
...
@Component({
  template: `
    <input [(ngModel)]="selected" [wtf2Datepicker]="d">
    <wtf2-datepicker (opened)="openedSpy()" (closed)="closedSpy()" #d></wtf2-datepicker>
  `,
})
...
@Component({
  template: `
    <input (focus)="d.open()" [wtf2Datepicker]="d">
    <wtf2-datepicker #d="wtf2Datepicker"></wtf2-datepicker>
  `,
})
class DatepickerOpeningOnFocus {
  @ViewChild(Wtf2Datepicker, {static: false}) datepicker: Wtf2Datepicker<Date>;
}


@Component({
  template: `
    <input [wtf2Datepicker]="ch">
    <wtf2-datepicker #ch [calendarHeaderComponent]="customHeaderForDatePicker"></wtf2-datepicker>
  `,
})
class DatepickerWithCustomHeader {
  @ViewChild('ch', {static: false}) datepicker: Wtf2Datepicker<Date>;
...
@Component({
  template: `
    ...
    <wtf2-calendar-header></wtf2-calendar-header>
  `,
})
...
@Component({
  template: `
    <input [wtf2Datepicker]="assignedDatepicker" [value]="date">
    <wtf2-datepicker #d [touchUi]="touch"></wtf2-datepicker>
  `,
})
class DelayedDatepicker {
  ...
  @ViewChild(Wtf2DatepickerInput, {static: false}) datepickerInput: Wtf2DatepickerInput<Date>;
  date: Date | null;
  assignedDatepicker: Wtf2Datepicker<Date>;
}
...
@Component({
  template: `
    <input [wtf2Datepicker]="d">
    <wtf2-datepicker-toggle tabIndex="7" [for]="d">
      <div class="custom-icon" wtf2DatepickerToggleIcon></div>
    </wtf2-datepicker-toggle>
    <wtf2-datepicker #d></wtf2-datepicker>
  `,
...
@Component({
  template: `
    <wtf2-datepicker-toggle></wtf2-datepicker-toggle>
  `,
})
