...
import {Wtf2RippleModule} from '../core';
...
describe('Wtf2TabHeader', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CommonModule, PortalModule, Wtf2RippleModule, ScrollingModule, ObserversModule],
      declarations: [
        Wtf2TabHeader,
        Wtf2InkBar,
        Wtf2TabLabelWrapper,
  ...
  describe('pagination', () => {
    describe('ltr', () => {
      ...
      it('should show ripples for pagination buttons', () => {
        ...
        const buttonAfter = fixture.debugElement.query(By.css('.wtf2-tab-header-pagination-after'));

        expect(fixture.nativeElement.querySelectorAll('.wtf2-ripple-element').length)
    ...
    describe('scrolling when holding paginator', () => {
      ...
      beforeEach(() => {
        ...
        nextButton = fixture.nativeElement.querySelector('.wtf2-tab-header-pagination-after');
        prevButton = fixture.nativeElement.querySelector('.wtf2-tab-header-pagination-before');
        header = fixture.componentInstance.tabHeader;
        headerElement = fixture.nativeElement.querySelector('.wtf2-tab-header');
      });
...
@Component({
  template: `
  <div [dir]="dir">
    <wtf2-tab-header [selectedIndex]="selectedIndex" [disableRipple]="disableRipple"
               (indexFocused)="focusedIndex = $event"
               (selectFocusedIndex)="selectedIndex = $event">
      <div wtf2TabLabelWrapper class="label-content" style="min-width: 30px; width: 30px"
...
class SimpleTabHeaderApp {
  ...
  @ViewChild(Wtf2TabHeader, {static: true}) tabHeader: Wtf2TabHeader;
