...
describe('Wtf2TabBody', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CommonModule, PortalModule, Wtf2RippleModule, NoopAnimationsModule],
      declarations: [
        Wtf2TabBody,
        Wtf2TabBodyPortal,
        SimpleTabBodyApp,
  ...
  describe('when initialized as center', () => {
    ...
    it('should be center position if origin is explicitly set to null', () => {
      ...
      // The `Wtf2Tab` class sets the origin by default to null. See related issue: #12455
...
@Component({
  template: `
    ...
    <wtf2-tab-body [content]="content" [position]="position" [origin]="origin"></wtf2-tab-body>
  `
})
class SimpleTabBodyApp implements AfterContentInit {
  ...
  @ViewChild(Wtf2TabBody, {static: false}) tabBody: Wtf2TabBody;
