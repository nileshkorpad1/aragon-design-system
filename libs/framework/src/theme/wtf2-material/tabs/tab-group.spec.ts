...
import {Wtf2Tab, Wtf2TabGroup, Wtf2TabHeaderPosition, Wtf2TabsModule} from './index';


describe('Wtf2TabGroup', () => {
  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2TabsModule, CommonModule, NoopAnimationsModule],
      declarations: [
        SimpleTabsTestApp,
  ...
  describe('basic behavior', () => {
    ...
    it('will properly load content on first change detection pass', () => {
      ...
      expect(element.querySelectorAll('.wtf2-tab-body')[1].querySelectorAll('span').length).toBe(3);
    });
    ...
    it('should change selected index on click', () => {
      ...
      let tabLabel = fixture.debugElement.queryAll(By.css('.wtf2-tab-label'))[1];
      tabLabel.nativeElement.click();
      checkSelectedIndex(1, fixture);

      // select the third tab
      tabLabel = fixture.debugElement.queryAll(By.css('.wtf2-tab-label'))[2];
      tabLabel.nativeElement.click();
    ...
    it('should change tabs based on selectedIndex', fakeAsync(() => {
      let component = fixture.componentInstance;
      let tabComponent = fixture.debugElement.query(By.css('wtf2-tab-group')).componentInstance;
    ...
    it('should update tab positions when selected index is changed', () => {
      fixture.detectChanges();
      const component: Wtf2TabGroup =
          fixture.debugElement.query(By.css('wtf2-tab-group')).componentInstance;
      const tabs: Wtf2Tab[] = component._tabs.toArray();
    ...
    it('should show ripples for tab-group labels', () => {
      ...
      const tabLabel = fixture.debugElement.queryAll(By.css('.wtf2-tab-label'))[1];

      expect(testElement.querySelectorAll('.wtf2-ripple-element').length)
    ...
    it('should add the proper `aria-setsize` and `aria-posinset`', () => {
      ...
      const labels = Array.from(element.querySelectorAll('.wtf2-tab-label'));
    ...
    it('should emit focusChange event on click', () => {
      ...
      const tabLabels = fixture.debugElement.queryAll(By.css('.wtf2-tab-label'));
    ...
    it('should emit focusChange on arrow key navigation', () => {
      ...
      const tabLabelContainer = fixture.debugElement
        .query(By.css('.wtf2-tab-label-container')).nativeElement as HTMLElement;
  ...
  describe('aria labelling', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      fixture.detectChanges();
      tick();
      tab = fixture.nativeElement.querySelector('.wtf2-tab-label');
    }));
  ...
  describe('disable tabs', () => {
    ...
    it('should have one disabled tab', () => {
      fixture.detectChanges();
      const labels = fixture.debugElement.queryAll(By.css('.wtf2-tab-disabled'));
    ...
    it('should set the disabled flag on tab', () => {
      ...
      const tabs = fixture.componentInstance.tabs.toArray();
      let labels = fixture.debugElement.queryAll(By.css('.wtf2-tab-disabled'));
      ...
      labels = fixture.debugElement.queryAll(By.css('.wtf2-tab-disabled'));
  ...
  describe('dynamic binding tabs', () => {
    ...
    it('should be able to add a new tab, select it, and have correct origin position',
      fakeAsync(() => {
        ...
        let tabs: Wtf2Tab[] = component._tabs.toArray();
  ...
  describe('async tabs', () => {
    ...
    it('should show tabs when they are available', fakeAsync(() => {
      ...
      expect(fixture.debugElement.queryAll(By.css('.wtf2-tab-label')).length).toBe(0);
      ...
      expect(fixture.debugElement.queryAll(By.css('.wtf2-tab-label')).length).toBe(2);
    }));
  });

  describe('with simple api', () => {
    let fixture: ComponentFixture<TabGroupWithSimpleApi>;
    let tabGroup: Wtf2TabGroup;
    ...
    beforeEach(fakeAsync(() => {
      ...
      tabGroup =
          fixture.debugElement.query(By.directive(Wtf2TabGroup)).componentInstance as Wtf2TabGroup;
    }));
    ...
    it('should support setting the header position', () => {
      let tabGroupNode = fixture.debugElement.query(By.css('wtf2-tab-group')).nativeElement;

      expect(tabGroupNode.classList).not.toContain('wtf2-tab-group-inverted-header');

      tabGroup.headerPosition = 'below';
      fixture.detectChanges();

      expect(tabGroupNode.classList).toContain('wtf2-tab-group-inverted-header');
    });
  });
  ...
  describe('lazy loaded tabs', () => {
    it('should lazy load the second tab', fakeAsync(() => {
      ...
      const secondLabel = fixture.debugElement.queryAll(By.css('.wtf2-tab-label'))[1];
  ...
  function checkSelectedIndex(expectedIndex: number, fixture: ComponentFixture<any>) {
    ...
    let tabComponent: Wtf2TabGroup = fixture.debugElement
        .query(By.css('wtf2-tab-group')).componentInstance;
    expect(tabComponent.selectedIndex).toBe(expectedIndex);

    let tabLabelElement = fixture.debugElement
        .query(By.css(`.wtf2-tab-label:nth-of-type(${expectedIndex + 1})`)).nativeElement;
    expect(tabLabelElement.classList.contains('wtf2-tab-label-active')).toBe(true);

    let tabContentElement = fixture.debugElement
        .query(By.css(`wtf2-tab-body:nth-of-type(${expectedIndex + 1})`)).nativeElement;
    expect(tabContentElement.classList.contains('wtf2-tab-body-active')).toBe(true);
  }

  function getSelectedLabel(fixture: ComponentFixture<any>): HTMLElement {
    return fixture.nativeElement.querySelector('.wtf2-tab-label-active');
  }

  function getSelectedContent(fixture: ComponentFixture<any>): HTMLElement {
    return fixture.nativeElement.querySelector('.wtf2-tab-body-active');
  }
});


describe('nested Wtf2TabGroup with enabled animations', () => {
  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2TabsModule, BrowserAnimationsModule],
...
@Component({
  template: `
    <wtf2-tab-group class="tab-group"
      ...
      <wtf2-tab>
        <ng-template wtf2-tab-label>Tab One</ng-template>
        Tab one content
      </wtf2-tab>
      <wtf2-tab>
        <ng-template wtf2-tab-label>Tab Two</ng-template>
        <span>Tab </span><span>two</span><span>content</span>
      </wtf2-tab>
      <wtf2-tab>
        <ng-template wtf2-tab-label>Tab Three</ng-template>
        Tab three content
      </wtf2-tab>
    </wtf2-tab-group>
  `
...
class SimpleTabsTestApp {
  @ViewChildren(Wtf2Tab) tabs: QueryList<Wtf2Tab>;
  selectedIndex: number = 1;
  focusEvent: any;
  selectEvent: any;
  disableRipple: boolean = false;
  headerPosition: Wtf2TabHeaderPosition = 'above';
...
@Component({
  template: `
    <wtf2-tab-group class="tab-group"
        ...
        (focusChange)="handleFocus($event)"
        (selectedTabChange)="handleSelection($event)">
      <wtf2-tab *ngFor="let tab of tabs">
        <ng-template wtf2-tab-label>{{tab.label}}</ng-template>
        {{tab.content}}
      </wtf2-tab>
    </wtf2-tab-group>
  `
...
@Component({
  template: `
    <wtf2-tab-group class="tab-group" [(selectedIndex)]="selectedIndex">
      <wtf2-tab *ngFor="let tab of tabs" label="{{tab.label}}">
        {{tab.content}}
      </wtf2-tab>
    </wtf2-tab-group>
  `
...
@Component({
  template: `
    <wtf2-tab-group class="tab-group">
      <wtf2-tab *ngFor="let tab of tabs | async">
        <ng-template wtf2-tab-label>{{ tab.label }}</ng-template>
        {{ tab.content }}
      </wtf2-tab>
   </wtf2-tab-group>
...
@Component({
  template: `
  <wtf2-tab-group>
    <wtf2-tab label="Junk food"> Pizza, fries </wtf2-tab>
    <wtf2-tab label="Vegetables"> Broccoli, spinach </wtf2-tab>
    <wtf2-tab [label]="otherLabel"> {{otherContent}} </wtf2-tab>
    <wtf2-tab label="Legumes"> <p #legumes>Peanuts</p> </wtf2-tab>
  </wtf2-tab-group>
  `
})
...
@Component({
  ...
  template: `
    <wtf2-tab-group>
      <wtf2-tab label="One">Tab one content</wtf2-tab>
      <wtf2-tab label="Two">
        Tab two content
         <wtf2-tab-group [dynamicHeight]="true">
          <wtf2-tab label="Inner tab one">Inner content one</wtf2-tab>
          <wtf2-tab label="Inner tab two">Inner content two</wtf2-tab>
        </wtf2-tab-group>
      </wtf2-tab>
    </wtf2-tab-group>
  `,
...
@Component({
 ...
 @Component({
  template: `
  <wtf2-tab-group>
    <wtf2-tab [aria-label]="ariaLabel" [aria-labelledby]="ariaLabelledby"></wtf2-tab>
  </wtf2-tab-group>
  `
})
...
@Component({
  template: `
    <wtf2-tab-group>
      <wtf2-tab label="Junk food" #pizza> Pizza, fries </wtf2-tab>
      <wtf2-tab label="Vegetables"> Broccoli, spinach </wtf2-tab>
    </wtf2-tab-group>
...
@Component({
  template: `
    <wtf2-tab-group animationDuration="500">
      <wtf2-tab label="One">Tab one content</wtf2-tab>
      <wtf2-tab label="Two">Tab two content</wtf2-tab>
    </wtf2-tab-group>
  `,
})
