...
import {
  Wtf2Ripple, Wtf2RippleModule, WTF2_RIPPLE_GLOBAL_OPTIONS, RippleState, RippleGlobalOptions
} from './index';
...
describe('Wtf2Ripple', () => {
  ...
  describe('basic ripple', () => {
    let rippleDirective: Wtf2Ripple;
    ...
    beforeEach(() => {
      ...
      rippleTarget = fixture.nativeElement.querySelector('.wtf2-ripple');
    ...
    it('sizes ripple to cover element', () => {
      ...
      let ripple = rippleTarget.querySelector('.wtf2-ripple-element') as HTMLElement;
    ...
    it('creates ripple on mousedown', () => {
      ...
      expect(rippleTarget.querySelectorAll('.wtf2-ripple-element').length).toBe(1);

      dispatchMouseEvent(rippleTarget, 'mousedown');
      dispatchMouseEvent(rippleTarget, 'mouseup');

      expect(rippleTarget.querySelectorAll('.wtf2-ripple-element').length).toBe(2);
    });
    ...
    it('should launch ripples on touchstart', fakeAsync(() => {
      ...
      expect(rippleTarget.querySelectorAll('.wtf2-ripple-element').length).toBe(0);
    }));
    ...
    it('should launch multiple ripples for multi-touch', fakeAsync(() => {
      ...
      expect(rippleTarget.querySelectorAll('.wtf2-ripple-element').length).toBe(3);
    ...
    it('should ignore fake mouse events from screen readers', fakeAsync(() => {
      ...
      tick(enterDuration);
      expect(rippleTarget.querySelector('.wtf2-ripple-element')).toBeFalsy();
    }));
    ...
    it('should not hide ripples while aniwtf2ing.', fakeAsync(() => {
      // Calculates the duration for fading-in and fading-out the ripple.
    ...
    it('creates manual ripples with the default ripple config', () => {
      ...
      let rippleElement = rippleTarget.querySelector('.wtf2-ripple-element') as HTMLElement;
    ...
    it('cleans up the event handlers when the container gets destroyed', () => {
      ...
      rippleTarget = fixture.debugElement.nativeElement.querySelector('.wtf2-ripple');
  ...
  describe('global ripple options', () => {
    ...
    function createTestComponent(rippleConfig: RippleGlobalOptions,
      ...
      TestBed.configureTestingModule({
        ...
        providers: [{ provide: WTF2_RIPPLE_GLOBAL_OPTIONS, useValue: rippleConfig }]
      });
  ...
  describe('with disabled animations', () => {
    ...
    beforeEach(() => {
      TestBed.resetTestingModule();
      TestBed.configureTestingModule({
        imports: [NoopAnimationsModule, Wtf2RippleModule],
  ...
  describe('configuring behavior', () => {
    ...
    it('sets ripple color', () => {
      ...
      let ripple = rippleTarget.querySelector('.wtf2-ripple-element')!;
...
@Component({
  template: `
    <div id="container" #ripple="wtf2Ripple" wtf2Ripple
         style="position: relative; width:300px; height:200px;">
    </div>
  `,
})
class BasicRippleContainer {
  @ViewChild('ripple', {static: false}) ripple: Wtf2Ripple;
}
...
@Component({
  template: `
    <div id="container" style="position: relative; width:300px; height:200px;"
      wtf2Ripple
      [wtf2RippleTrigger]="trigger"
      [wtf2RippleCentered]="centered"
      [wtf2RippleRadius]="radius"
      [wtf2RippleDisabled]="disabled"
      [wtf2RippleAnimation]="animationConfig"
      [wtf2RippleColor]="color">
    </div>
...
@Component({
  template: `<div id="container" #ripple="wtf2Ripple" wtf2Ripple></div>`,
})
class RippleContainerWithoutBindings {}

@Component({ template: `<div id="container" wtf2Ripple
