...
import {getAppModulePath} from '@schewtf2ics/angular/utility/ng-ast-utils';
...
function addAnimationsModule(options: Schema) {
  return (host: Tree) => {
    ...
    if (options.animations) {
      ...
      // message that makes the user aware of the fact that we won't autowtf2ically set up
