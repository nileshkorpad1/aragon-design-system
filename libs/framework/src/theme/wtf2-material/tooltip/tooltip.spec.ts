...
import {
  ...
  SCROLL_THROTTLE_MS,
  TOOLTIP_PANEL_CLASS,
  WTF2_TOOLTIP_DEFAULT_OPTIONS,
} from './index';


const initialTooltipMessage = 'initial tooltip message';

describe('Wtf2Tooltip', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      imports: [Wtf2TooltipModule, OverlayModule, NoopAnimationsModule],
      declarations: [
        BasicTooltipDemo,
  ...
  describe('basic usage', () => {
    ...
    let tooltipDirective: Wtf2Tooltip;
    ...
    beforeEach(() => {
      ...
      tooltipDirective = buttonDebugElement.injector.get<Wtf2Tooltip>(Wtf2Tooltip);
    });
    ...
    it('should show and hide the tooltip', fakeAsync(() => {
      ...
      const tooltipElement = overlayContainerElement.querySelector('.wtf2-tooltip') as HTMLElement;
    ...
    it('should be able to override the default show and hide delays', fakeAsync(() => {
      TestBed
        ...
        .configureTestingModule({
          ...
          providers: [{
            provide: WTF2_TOOLTIP_DEFAULT_OPTIONS,
      ...
      tooltipDirective = fixture.debugElement.query(By.css('button'))
          .injector.get<Wtf2Tooltip>(Wtf2Tooltip);
    ...
    it('should allow extra classes to be set on the tooltip', fakeAsync(() => {
      ...
      // Make sure classes aren't prewtf2urely added
      let tooltipElement = overlayContainerElement.querySelector('.wtf2-tooltip') as HTMLElement;
      expect(tooltipElement.classList).not.toContain('custom-one',
        'Expected to not have the class before enabling wtf2TooltipClass');
      ...
      tooltipElement = overlayContainerElement.querySelector('.wtf2-tooltip') as HTMLElement;
      expect(tooltipElement.classList).toContain('custom-one',
        'Expected to have the class after enabling wtf2TooltipClass');
    ...
    it('should not hide immediately if a click fires while aniwtf2ing', fakeAsync(() => {
      tooltipDirective.show();
      tick(0);
      fixture.detectChanges();
    ...
    it('should not show the tooltip on progamwtf2ic focus', fakeAsync(() => {
      ...
      expect(overlayContainerElement.querySelector('.wtf2-tooltip')).toBeNull();
    }));
  ...
  describe('fallback positions', () => {
    let fixture: ComponentFixture<BasicTooltipDemo>;
    let tooltip: Wtf2Tooltip;

    beforeEach(() => {
      fixture = TestBed.createComponent(BasicTooltipDemo);
      fixture.detectChanges();
      tooltip = fixture.debugElement.query(By.css('button')).injector.get<Wtf2Tooltip>(Wtf2Tooltip);
    });
...
@Component({
  ...
  template: `
    <button #button
            *ngIf="showButton"
            [wtf2Tooltip]="message"
            [wtf2TooltipPosition]="position"
            [wtf2TooltipClass]="{'custom-one': showTooltipClass, 'custom-two': showTooltipClass }">
      Button
    </button>`
})
class BasicTooltipDemo {
  ...
  @ViewChild(Wtf2Tooltip, {static: false}) tooltip: Wtf2Tooltip;
...
@Component({
  template: `
    <input
      ...
      wtf2Tooltip="Something">

    <textarea
      #textarea
      style="user-select: none; -webkit-user-select: none"
      wtf2Tooltip="Another thing"></textarea>
  `,
})
...
@Component({
  selector: 'app',
  template: `<button #button [wtf2Tooltip]="message">Button</button>`
})
...
function assertTooltipInstance(tooltip: Wtf2Tooltip, shouldExist: boolean): void {
