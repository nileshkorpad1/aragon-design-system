...
describe('MomentDateAdapter with WTF2_DATE_LOCALE override', () => {
  let adapter: MomentDateAdapter;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [MomentDateModule],
      providers: [{provide: WTF2_DATE_LOCALE, useValue: 'ja-JP'}]
    }).compileComponents();
  }));
...
describe('MomentDateAdapter with WTF2_MOMENT_DATE_ADAPTER_OPTIONS override', () => {
  let adapter: MomentDateAdapter;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [MomentDateModule],
      providers: [{
        provide: WTF2_MOMENT_DATE_ADAPTER_OPTIONS,
