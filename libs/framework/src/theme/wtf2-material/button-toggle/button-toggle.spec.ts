...
import {
  Wtf2ButtonToggle,
  Wtf2ButtonToggleChange,
  Wtf2ButtonToggleGroup,
  Wtf2ButtonToggleGroupMultiple,
  Wtf2ButtonToggleModule,
} from './index';

describe('Wtf2ButtonToggle with forms', () => {

  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2ButtonToggleModule, FormsModule, ReactiveFormsModule],
      declarations: [
  ...
  describe('using FormControl', () => {
    ...
    let groupInstance: Wtf2ButtonToggleGroup;
    ...
    beforeEach(fakeAsync(() => {
      ...
      groupDebugElement = fixture.debugElement.query(By.directive(Wtf2ButtonToggleGroup));
      groupInstance = groupDebugElement.injector.get<Wtf2ButtonToggleGroup>(Wtf2ButtonToggleGroup);
    }));
  ...
  describe('button toggle group with ngModel and change event', () => {
    ...
    let groupInstance: Wtf2ButtonToggleGroup;
    let buttonToggleInstances: Wtf2ButtonToggle[];
    ...
    beforeEach(fakeAsync(() => {
      ...
      buttonToggleDebugElements = fixture.debugElement.queryAll(By.directive(Wtf2ButtonToggle));
    ...
    it('should check the corresponding button toggle on a group value change', () => {
      ...
      const selected = groupInstance.selected as Wtf2ButtonToggle;
    ...
    it('should show a ripple on label click', () => {
      ...
      expect(groupElement.querySelectorAll('.wtf2-ripple-element').length).toBe(0);

      dispatchMouseEvent(innerButtons[0], 'mousedown');
      dispatchMouseEvent(innerButtons[0], 'mouseup');

      expect(groupElement.querySelectorAll('.wtf2-ripple-element').length).toBe(1);
    });
...
describe('Wtf2ButtonToggle without forms', () => {

  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2ButtonToggleModule],
      declarations: [
  ...
  describe('inside of an exclusive selection group', () => {
    ...
    it('should change the vertical state', () => {
      expect(groupNativeElement.classList).not.toContain('wtf2-button-toggle-vertical');

      groupInstance.vertical = true;
      fixture.detectChanges();

      expect(groupNativeElement.classList).toContain('wtf2-button-toggle-vertical');
    });
  ...
  describe('with initial value and change event', () => {
    ...
    it('should not fire an initial change event', () => {
      ...
      let groupDebugElement = fixture.debugElement.query(By.directive(Wtf2ButtonToggleGroup));
      let groupInstance: Wtf2ButtonToggleGroup = groupDebugElement.injector
          .get<Wtf2ButtonToggleGroup>(Wtf2ButtonToggleGroup);
  ...
  describe('inside of a multiple selection group', () => {
    ...
    it('should be able to query for the deprecated `Wtf2ButtonToggleGroupMultiple`', () => {
      expect(fixture.debugElement.query(By.directive(Wtf2ButtonToggleGroupMultiple))).toBeTruthy();
    });
  ...
  describe('as standalone', () => {
    ...
    let buttonToggleInstance: Wtf2ButtonToggle;
    ...
    beforeEach(fakeAsync(() => {
      ...
      buttonToggleDebugElement = fixture.debugElement.query(By.directive(Wtf2ButtonToggle));
      buttonToggleNativeElement = buttonToggleDebugElement.nativeElement;
      buttonToggleLabelElement = fixture.debugElement
          .query(By.css('.wtf2-button-toggle-label-content')).nativeElement;
  ...
  describe('aria-label handling ', () => {
    it('should not set the aria-label attribute if none is provided', () => {
      ...
      let checkboxDebugElement = fixture.debugElement.query(By.directive(Wtf2ButtonToggle));
  ...
  describe('with provided aria-labelledby ', () => {
    ...
    it('should use the provided aria-labelledby', () => {
      ...
      checkboxDebugElement = fixture.debugElement.query(By.directive(Wtf2ButtonToggle));
  ...
  describe('with tabindex', () => {
    it('should forward the tabindex to the underlying button', () => {
      ...
      const button = fixture.nativeElement.querySelector('.wtf2-button-toggle button');
    ...
    it('should clear the tabindex from the host element', () => {
      ...
      const host = fixture.nativeElement.querySelector('.wtf2-button-toggle');
  ...
  it('should not throw on init when toggles are repeated and there is an initial value', () => {
    ...
    const hostNode: HTMLElement = fixture.nativeElement.querySelector('.wtf2-button-toggle');
...
@Component({
  template: `
  <wtf2-button-toggle-group [disabled]="isGroupDisabled"
                           [vertical]="isVertical"
                           [(value)]="groupValue">
    <wtf2-button-toggle value="test1" *ngIf="renderFirstToggle">Test1</wtf2-button-toggle>
    <wtf2-button-toggle value="test2">Test2</wtf2-button-toggle>
    <wtf2-button-toggle value="test3">Test3</wtf2-button-toggle>
...
@Component({
  ...
  <wtf2-button-toggle-group
    ...
    <wtf2-button-toggle *ngFor="let option of options" [value]="option.value"
...
class ButtonToggleGroupWithNgModel {
  ...
  lastEvent: Wtf2ButtonToggleChange;
  disableRipple = false;
}

@Component({
  template: `
  <wtf2-button-toggle-group [disabled]="isGroupDisabled" [vertical]="isVertical" multiple>
    <wtf2-button-toggle value="eggs">Eggs</wtf2-button-toggle>
    <wtf2-button-toggle value="flour">Flour</wtf2-button-toggle>
    <wtf2-button-toggle value="sugar">Sugar</wtf2-button-toggle>
  </wtf2-button-toggle-group>
  `
})
...
@Component({
  template: `
  <wtf2-button-toggle-group multiple [value]="value">
    <wtf2-button-toggle [value]="0">Eggs</wtf2-button-toggle>
    <wtf2-button-toggle [value]="null">Flour</wtf2-button-toggle>
    <wtf2-button-toggle [value]="false">Sugar</wtf2-button-toggle>
    <wtf2-button-toggle>Sugar</wtf2-button-toggle>
  </wtf2-button-toggle-group>
  `
})
class FalsyButtonTogglesInsideButtonToggleGroupMultiple {
  value: ('' | number | null | undefined | boolean)[] = [0];
  @ViewChildren(Wtf2ButtonToggle) toggles: QueryList<Wtf2ButtonToggle>;
}

@Component({
  template: `
  <wtf2-button-toggle>Yes</wtf2-button-toggle>
  `
})
...
@Component({
  template: `
  <wtf2-button-toggle-group (change)="lastEvent = $event" value="red">
    <wtf2-button-toggle value="red">Value Red</wtf2-button-toggle>
    <wtf2-button-toggle value="green">Value Green</wtf2-button-toggle>
  </wtf2-button-toggle-group>
  `
})
...
@Component({
  template: `
  <wtf2-button-toggle-group [formControl]="control">
    <wtf2-button-toggle value="red">Value Red</wtf2-button-toggle>
    <wtf2-button-toggle value="green">Value Green</wtf2-button-toggle>
    <wtf2-button-toggle value="blue">Value Blue</wtf2-button-toggle>
  </wtf2-button-toggle-group>
  `
})
...
@Component({
  template: `<wtf2-button-toggle aria-label="Super effective"></wtf2-button-toggle>`
})
class ButtonToggleWithAriaLabel { }

/** Simple test component with an aria-label set. */
@Component({
  template: `<wtf2-button-toggle aria-labelledby="some-id"></wtf2-button-toggle>`
})
...
@Component({
  template: `
    <wtf2-button-toggle-group [(value)]="value">
      <wtf2-button-toggle *ngFor="let toggle of possibleValues" [value]="toggle">
        {{toggle}}
      </wtf2-button-toggle>
    </wtf2-button-toggle-group>
  `
...
class RepeatedButtonTogglesWithPreselectedValue {
  @ViewChild(Wtf2ButtonToggleGroup, {static: false}) toggleGroup: Wtf2ButtonToggleGroup;
  @ViewChildren(Wtf2ButtonToggle) toggles: QueryList<Wtf2ButtonToggle>;
...
@Component({
  template: `<wtf2-button-toggle tabindex="3"></wtf2-button-toggle>`
})
class ButtonToggleWithTabindex {}

@Component({
  template: `<wtf2-button-toggle name="custom-name"></wtf2-button-toggle>`
})
