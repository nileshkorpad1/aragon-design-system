...
import {Wtf2SelectModule} from './index';
import {Wtf2Select} from './select';
import {
  getWtf2SelectDynamicMultipleError,
  getWtf2SelectNonArrayValueError,
  getWtf2SelectNonFunctionValueError,
} from './select-errors';
...
describe('Wtf2Select', () => {
  ...
  /**
   * Configures the test module for Wtf2Select with the given declarations. This is broken out so
   * that we're only compiling the necessary test components for each test in order to speed up
   * overall test time.
   * @param declarations Components to declare for this block
   */
  function configureWtf2SelectTestingModule(declarations: any[]) {
  ...
  describe('core', () => {
    beforeEach(async(() => {
      configureWtf2SelectTestingModule([
        BasicSelect,
        MultiSelect,
        SelectWithGroups,
    ...
    describe('accessibility', () => {
      describe('for select', () => {
        ...
        beforeEach(fakeAsync(() => {
          ...
          select = fixture.debugElement.query(By.css('wtf2-select')).nativeElement;
        }));
        ...
        it('should set the wtf2-select-required class for required selects', fakeAsync(() => {
          expect(select.classList).not.toContain(
              'wtf2-select-required', `Expected the wtf2-select-required class not to be set.`);

          fixture.componentInstance.isRequired = true;
          fixture.detectChanges();

          expect(select.classList).toContain(
              'wtf2-select-required', `Expected the wtf2-select-required class to be set.`);
        }));
        ...
        it('should set `aria-labelledby` to form field label if there is no placeholder', () => {
          ...
          select = labelFixture.debugElement.query(By.css('wtf2-select')).nativeElement;
        ...
        it('should resume focus from selected item after selecting via click', fakeAsync(() => {
          ...
          (overlayContainerElement.querySelectorAll('wtf2-option')[3] as HTMLElement).click();
          fixture.detectChanges();
          flush();
        ...
        it('should open the panel when pressing a vertical arrow key on a closed multiple select',
          fakeAsync(() => {
            ...
            select = multiFixture.debugElement.query(By.css('wtf2-select')).nativeElement;
        ...
        it('should continue from the selected option when the value is set programwtf2ically',
            fakeAsync(() => {
              const formControl = fixture.componentInstance.control;
        ...
        it('should not shift focus when the selected options are updated programwtf2ically ' +
        ...
        it('should set aria-hidden on the trigger element', fakeAsync(() => {
          const trigger = fixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
        ...
        it('should set aria-activedescendant only while the panel is open', fakeAsync(() => {
          ...
          const host = fixture.debugElement.query(By.css('wtf2-select')).nativeElement;
          ...
          const options = overlayContainerElement.querySelectorAll('wtf2-option');
      ...
      describe('for options', () => {
        ...
        beforeEach(fakeAsync(() => {
          fixture = TestBed.createComponent(BasicSelect);
          fixture.detectChanges();
          trigger = fixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
          trigger.click();
          fixture.detectChanges();

          options = Array.from(overlayContainerElement.querySelectorAll('wtf2-option'));
        }));

        it('should set the role of wtf2-option to option', fakeAsync(() => {
        ...
        it('should set aria-selected on each option for multi-select', fakeAsync(() => {
          ...
          trigger = multiFixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
          trigger.click();
          multiFixture.detectChanges();
      ...
      describe('for option groups', () => {
        ...
        beforeEach(fakeAsync(() => {
          ...
          fixture.detectChanges();
          groups =
              overlayContainerElement.querySelectorAll('wtf2-optgroup') as NodeListOf<HTMLElement>;
        }));
    ...
    describe('overlay panel', () => {
      ...
      it('should set the width of the overlay based on the trigger', fakeAsync(() => {
        ...
        const scrollContainer = document.querySelector('.cdk-overlay-pane .wtf2-select-panel');
      ...
      it('should set the width of the overlay based on a larger trigger width',
        fakeAsync(() => {
            // the trigger width exceeds the minimum width of the wtf2-select-panel
      ...
      it('should close when tabbing out from inside the panel', fakeAsync(() => {
        ...
        const panel = overlayContainerElement.querySelector('.wtf2-select-panel')!;
      ...
      it('should be able to set extra classes on the panel', fakeAsync(() => {
        ...
        const panel = overlayContainerElement.querySelector('.wtf2-select-panel') as HTMLElement;
      ...
      it('should not show ripples if they were disabled', fakeAsync(() => {
        ...
        const option = overlayContainerElement.querySelector('wtf2-option')!;

        dispatchFakeEvent(option, 'mousedown');
        dispatchFakeEvent(option, 'mouseup');

        expect(option.querySelectorAll('.wtf2-ripple-element').length).toBe(0);
      }));
      ...
      it('should be able to render options inside groups with an ng-container', fakeAsync(() => {
        ...
        trigger = groupFixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
        trigger.click();
        groupFixture.detectChanges();

        expect(document.querySelectorAll('.cdk-overlay-container wtf2-option').length)
      ...
      it('should not consider itself as blurred if the trigger loses focus while the ' +
        'panel is still open', fakeAsync(() => {
          const selectElement = fixture.nativeElement.querySelector('.wtf2-select');
    ...
    describe('selection logic', () => {
      ...
      beforeEach(fakeAsync(() => {
        ...
        fixture.detectChanges();
        trigger = fixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
        formField = fixture.debugElement.query(By.css('.wtf2-form-field')).nativeElement;
      }));

      it('should not float label if no option is selected', fakeAsync(() => {
        expect(formField.classList.contains('wtf2-form-field-should-float'))
      ...
      it('should select an option when it is clicked', fakeAsync(() => {
        ...
        let option = overlayContainerElement.querySelector('wtf2-option') as HTMLElement;
        option.click();
        fixture.detectChanges();
        flush();
        ...
        option = overlayContainerElement.querySelector('wtf2-option') as HTMLElement;

        expect(option.classList).toContain('wtf2-selected');
        expect(fixture.componentInstance.options.first.selected).toBe(true);
        expect(fixture.componentInstance.select.selected)
            .toBe(fixture.componentInstance.options.first);
      }));

      it('should be able to select an option using the Wtf2Option API', fakeAsync(() => {
        trigger.click();
        fixture.detectChanges();
        flush();
        ...
        const optionNodes: NodeListOf<HTMLElement> =
            overlayContainerElement.querySelectorAll('wtf2-option');

        optionInstances[1].select();
        fixture.detectChanges();

        expect(optionNodes[1].classList).toContain('wtf2-selected');
      ...
      it('should deselect other options when one is selected', fakeAsync(() => {
        ...
        options =
            overlayContainerElement.querySelectorAll('wtf2-option') as NodeListOf<HTMLElement>;
        expect(options[1].classList).not.toContain('wtf2-selected');
        expect(options[2].classList).not.toContain('wtf2-selected');
      ...
      it('should deselect other options when one is programwtf2ically selected', fakeAsync(() => {
        ...
        expect(options[0].classList)
            .not.toContain('wtf2-selected', 'Expected first option to no longer be selected');
        expect(options[1].classList)
            .toContain('wtf2-selected', 'Expected second option to be selected');
      ...
      it('should remove selection if option has been removed', fakeAsync(() => {
        ...
        let firstOption = overlayContainerElement.querySelectorAll('wtf2-option')[0] as HTMLElement;
      ...
      it('should display the selected option in the trigger', fakeAsync(() => {
        ...
        const value = fixture.debugElement.query(By.css('.wtf2-select-value')).nativeElement;
      ...
      it('should not select options inside a disabled group', fakeAsync(() => {
        ...
        groupFixture.detectChanges();
        groupFixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement.click();
        groupFixture.detectChanges();

        const disabledGroup = overlayContainerElement.querySelectorAll('wtf2-optgroup')[1];
        const options = disabledGroup.querySelectorAll('wtf2-option');

        (options[0] as HTMLElement).click();
        groupFixture.detectChanges();

        expect(groupFixture.componentInstance.select.panelOpen).toBe(true);
        expect(options[0].classList).not.toContain('wtf2-selected');
    ...
    describe('forms integration', () => {
      ...
      it('should take an initial view value with reactive forms', fakeAsync(() => {
        ...
        const value = fixture.debugElement.query(By.css('.wtf2-select-value'));
      ...
      it('should set the view value from the form', fakeAsync(() => {
        ...
        expect(options[1].classList).toContain(
            'wtf2-selected', `Expected option with the control's new value to be selected.`);
      }));
      ...
      it('should clear the selection when a nonexistent option value is selected', fakeAsync(() => {
        ...
        const options =
            overlayContainerElement.querySelectorAll('wtf2-option') as NodeListOf<HTMLElement>;
        expect(options[1].classList)
            .not.toContain('wtf2-selected', `Expected option w/ the old value not to be selected.`);
      }));
      ...
      it('should not set the control to dirty when the value changes programwtf2ically',
          fakeAsync(() => {
            expect(fixture.componentInstance.control.dirty)
                .toEqual(false, `Expected control to start out pristine.`);
            ...
            expect(fixture.componentInstance.control.dirty)
                .toEqual(false, `Expected control to stay pristine after programwtf2ic change.`);
          }));

      it('should set an asterisk after the label if control is required', fakeAsync(() => {
        let requiredMarker = fixture.debugElement.query(By.css('.wtf2-form-field-required-marker'));
        ...
        requiredMarker = fixture.debugElement.query(By.css('.wtf2-form-field-required-marker'));
        expect(requiredMarker)
    ...
    describe('disabled behavior', () => {
      it('should disable itself when control is disabled programwtf2ically', fakeAsync(() => {
        ...
        fixture.detectChanges();
        let trigger =
            fixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
    ...
    describe('animations', () => {
      ...
      it('should float the label when the panel is open and unselected', fakeAsync(() => {
        ...
        expect(formField.classList).toContain('wtf2-form-field-should-float',
        ...
        expect(formField.classList).not.toContain('wtf2-form-field-should-float',
    ...
    describe('keyboard scrolling', () => {
      ...
      beforeEach(fakeAsync(() => {
        ...
        host = fixture.debugElement.query(By.css('wtf2-select')).nativeElement;
        panel = overlayContainerElement.querySelector('.wtf2-select-panel')! as HTMLElement;
      }));
      ...
      it('should skip option group labels', fakeAsync(() => {
        ...
        host = groupFixture.debugElement.query(By.css('wtf2-select')).nativeElement;
        panel = overlayContainerElement.querySelector('.wtf2-select-panel')! as HTMLElement;
  ...
  describe('when initialized without options', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectInitWithoutOptions])));
  ...
  describe('with a selectionChange event handler', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectWithChangeEvent])));
    ...
    it('should emit an event when the selected option has changed', fakeAsync(() => {
      ...
      (overlayContainerElement.querySelector('wtf2-option') as HTMLElement).click();
    ...
    it('should only emit one event when pressing arrow keys on closed select', fakeAsync(() => {
      const select = fixture.debugElement.query(By.css('wtf2-select')).nativeElement;
      dispatchKeyboardEvent(select, 'keydown', DOWN_ARROW);
  ...
  describe('with ngModel', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([NgModelSelect])));
  ...
  describe('with ngIf', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([NgIfSelect])));
  ...
  describe('with multiple wtf2-select elements in one view', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([ManySelects])));
      ...
      beforeEach(fakeAsync(() => {
        ...
        fixture.detectChanges();
        triggers = fixture.debugElement.queryAll(By.css('.wtf2-select-trigger'));
      ...
      it('should set aria-owns properly', fakeAsync(() => {
        const selects = fixture.debugElement.queryAll(By.css('wtf2-select'));
      ...
      it('should remove aria-owns when the options are not visible', fakeAsync(() => {
        const select = fixture.debugElement.query(By.css('wtf2-select'));
      ...
      it('should set the option id properly', fakeAsync(() => {
        ...
        expect(options[0].id)
            .toContain('wtf2-option', `Expected option ID to have the correct prefix.`);
  ...
  describe('with floatLabel', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([FloatLabelSelect])));
    ...
    it('should be able to disable the floating label', fakeAsync(() => {
      ...
      expect(formField.classList.contains('wtf2-form-field-can-float'))
    ...
    it ('should default to global floating label type', fakeAsync(() => {
      ...
      TestBed.configureTestingModule({
        ...
        providers: [{ provide: WTF2_LABEL_GLOBAL_OPTIONS, useValue: { float: 'always' } }]
      });
  ...
  describe('with a sibling component that throws an error', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([
  ...
  describe('with tabindex', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectWithPlainTabindex])));
  ...
  describe('change events', () => {
    ...
    it('should complete the stateChanges stream on destroy', () => {
      ...
      const debugElement = fixture.debugElement.query(By.directive(Wtf2Select));
  ...
  describe('when initially hidden', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([BasicSelectInitiallyHidden])));
  ...
  describe('with no placeholder', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([BasicSelectNoPlaceholder])));
  ...
  describe('with theming', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([BasicSelectWithTheming])));
    ...
    it('should transfer the theme to the select panel', fakeAsync(() => {
      ...
      const panel = overlayContainerElement.querySelector('.wtf2-select-panel')! as HTMLElement;
      expect(panel.classList).toContain('wtf2-warn');
    }));
  });

  describe('when invalid inside a form', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([InvalidSelectInForm])));
  ...
  describe('with ngModel using compareWith', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([NgModelCompareWithSelect])));
    ...
    describe('comparing by value', () => {
      ...
      it('should have a selection', fakeAsync(() => {
        const selectedOption = instance.select.selected as Wtf2Option;
    ...
    describe('comparing by reference', () => {
      ...
      it('should throw an error when using a non-function comparator', fakeAsync(() => {
        ...
        expect(() => {
          fixture.detectChanges();
        }).toThrowError(wrappedErrorMessage(getWtf2SelectNonFunctionValueError()));
      }));
    });
  });

  describe(`when the select's value is accessed on initialization`, () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectEarlyAccessSibling])));
  ...
  describe('with ngIf and wtf2-label', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectWithNgIfAndLabel])));
  ...
  describe('inside of a form group', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectInsideFormGroup])));
    ...
    it('should not set the invalid class on a clean select', fakeAsync(() => {
      ...
      expect(select.classList)
          .not.toContain('wtf2-select-invalid', 'Expected select not to appear invalid.');
      expect(select.getAttribute('aria-invalid'))
    ...
    it('should appear as invalid if it becomes touched', fakeAsync(() => {
      ...
      expect(select.classList)
          .toContain('wtf2-select-invalid', 'Expected select to appear invalid.');
      expect(select.getAttribute('aria-invalid'))
    ...
    it('should render the error messages when the parent form is submitted', fakeAsync(() => {
      ...
      expect(debugEl.querySelectorAll('wtf2-error').length).toBe(0, 'Expected no error messages');

      dispatchFakeEvent(fixture.debugElement.query(By.css('form')).nativeElement, 'submit');
      fixture.detectChanges();

      expect(debugEl.querySelectorAll('wtf2-error').length).toBe(1, 'Expected one error message');
    }));
    ...
    it('should override error matching behavior via injection token', fakeAsync(() => {
      ...
      TestBed.resetTestingModule().configureTestingModule({
        imports: [Wtf2SelectModule, ReactiveFormsModule, FormsModule, NoopAnimationsModule],
  ...
  describe('with custom error behavior', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([CustomErrorBehaviorSelect])));
  ...
  describe('with custom value accessor', () => {
    ...
    it('should support use inside a custom value accessor', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.customAccessor.select.ngControl)
          .toBeFalsy('Expected wtf2-select NOT to inherit control from parent value accessor.');
      expect(fixture.componentInstance.customAccessor.writeValue).toHaveBeenCalled();
    }));
  });

  describe('with a falsy value', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([FalsyValueSelect])));

    it('should be able to programwtf2ically select a falsy option', fakeAsync(() => {
      const fixture = TestBed.createComponent(FalsyValueSelect);

      fixture.detectChanges();
      fixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement.click();
      ...
      expect(overlayContainerElement.querySelectorAll('wtf2-option')[0].classList)
          .toContain('wtf2-selected', 'Expected first option to be selected');
    }));
  });
  ...
  describe('with custom trigger', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([SelectWithCustomTrigger])));
    ...
    it('should allow the user to customize the label', fakeAsync(() => {
      ...
      const label = fixture.debugElement.query(By.css('.wtf2-select-value')).nativeElement;
  ...
  describe('when reseting the value by setting null or undefined', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([ResetValuesSelect])));
    ...
    it('should not mark the reset option as selected ', fakeAsync(() => {
      ...
      expect(options[5].classList).not.toContain('wtf2-selected');
    }));
    ...
    it('should not consider the reset values as selected when resetting the form control',
        fakeAsync(() => {
          ...
          expect(fixture.componentInstance.control.value).toBeNull();
          expect(fixture.componentInstance.select.selected).toBeFalsy();
          expect(formField.classList).not.toContain('wtf2-formf-field-should-float');
          expect(trigger.textContent).not.toContain('Null');
          expect(trigger.textContent).not.toContain('Undefined');
        }));
  });
  ...
  describe('without Angular forms', () => {
    ...
    it('should set the value when options are clicked', fakeAsync(() => {
      ...
      (overlayContainerElement.querySelectorAll('wtf2-option')[2] as HTMLElement).click();
      fixture.detectChanges();
      flush();
    ...
    it('should mark options as selected when the value is set', fakeAsync(() => {
      ...
      const option = overlayContainerElement.querySelectorAll('wtf2-option')[2];
    ...
    it('should reflect the preselected value', fakeAsync(() => {
      ...
      const option = overlayContainerElement.querySelectorAll('wtf2-option')[1];
    ...
    it('should restore focus to the host element', fakeAsync(() => {
      ...
      const select = fixture.debugElement.nativeElement.querySelector('wtf2-select');
    ...
    it('should not restore focus to the host element when clicking outside', fakeAsync(() => {
      ...
      select.blur(); // Blur manually since the programwtf2ic click might not do it.
  ...
  describe('positioning', () => {
     ...
     * @param selectInstance Instance of the `wtf2-select` component to check against.
     */
    function checkTriggerAlignedWithOption(index: number, selectInstance =
      ...
      const options = overlayPane.querySelectorAll('wtf2-option');
    ...
    describe('ample space to open', () => {
      ...
      it('should account for preceding label groups when aligning the option', fakeAsync(() => {
        ...
        groupFixture.detectChanges();
        trigger = groupFixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
        formField = groupFixture.debugElement.query(By.css('wtf2-form-field')).nativeElement;
    ...
    describe('limited space to open vertically', () => {
      ...
      it('should adjust position of centered option if there is little space above',
          fakeAsync(() => {
            ...
            // Position of select relative to top edge of wtf2-form-field.
      ...
      it('should adjust position of centered option if there is little space below',
          fakeAsync(() => {
            ...
            // Position of select relative to bottom edge of wtf2-form-field:
      ...
      it('should fall back to "above" positioning if scroll adjustment will not help',
          fakeAsync(() => {
            ...
            const scrollContainer = overlayPane.querySelector('.wtf2-select-panel')!;
    ...
    describe('limited space to open horizontally', () => {
      ...
      it('should stay within the viewport when overflowing on the left in ltr', fakeAsync(() => {
        ...
        const panelLeft = document.querySelector('.wtf2-select-panel')!.getBoundingClientRect().left;
      ...
      it('should stay within the viewport when overflowing on the right in ltr', fakeAsync(() => {
        ...
        const panelRight = document.querySelector('.wtf2-select-panel')!
      ...
      it('should keep the position within the viewport on repeat openings', fakeAsync(() => {
        ...
        let panelLeft = document.querySelector('.wtf2-select-panel')!.getBoundingClientRect().left;
        ...
        panelLeft = document.querySelector('.wtf2-select-panel')!.getBoundingClientRect().left;
    ...
    describe('when scrolled', () => {
      ...
      it('should align the first option properly when scrolled', fakeAsync(() => {
        ...
        // 256 (height of the menu overlay) - 45 (estiwtf2ed height of the trigger)
    ...
    describe('x-axis positioning', () => {
      ...
      it('should align the trigger and the selected option on the x-axis in ltr', fakeAsync(() => {
        ...
        const firstOptionLeft = document.querySelector('.cdk-overlay-pane wtf2-option')!
      ...
      it('should align the trigger and the selected option on the x-axis in rtl', fakeAsync(() => {
        ...
        const firstOptionRight =
            document.querySelector('.cdk-overlay-pane wtf2-option')!.getBoundingClientRect().right;
    ...
    describe('x-axis positioning in multi select mode', () => {
      ...
      beforeEach(fakeAsync(() => {
        ...
        multiFixture.detectChanges();
        formField = multiFixture.debugElement.query(By.css('.wtf2-form-field')).nativeElement;
        trigger = multiFixture.debugElement.query(By.css('.wtf2-select-trigger')).nativeElement;
      ...
      it('should adjust for the checkbox in ltr', fakeAsync(() => {
        ...
        const firstOptionLeft =
            document.querySelector('.cdk-overlay-pane wtf2-option')!.getBoundingClientRect().left;
    ...
    describe('x-axis positioning with groups', () => {
      ...
      it('should adjust for the group padding in ltr', fakeAsync(() => {
        ...
        groupFixture.whenStable().then(() => {
          const group = document.querySelector('.cdk-overlay-pane wtf2-optgroup')!;
          const triggerLeft = trigger.getBoundingClientRect().left;
          const selectedOptionLeft = group.querySelector('wtf2-option.wtf2-selected')!
              .getBoundingClientRect().left;
      ...
      it('should adjust for the group padding in rtl', fakeAsync(() => {
        ...
        const group = document.querySelector('.cdk-overlay-pane wtf2-optgroup')!;
        const triggerRight = trigger.getBoundingClientRect().right;
        const selectedOptionRight = group.querySelector('wtf2-option.wtf2-selected')!
            .getBoundingClientRect().right;
      ...
      it('should not adjust if all options are within a group, except the selected one',
          fakeAsync(() => {
            ...
            const selected = document.querySelector('.cdk-overlay-pane wtf2-option.wtf2-selected')!;
      ...
      it('should align the first option to the trigger, if nothing is selected', fakeAsync(() => {
        ...
        const option = overlayContainerElement.querySelector('.cdk-overlay-pane wtf2-option');
  ...
  describe('with multiple selection', () => {
    beforeEach(async(() => configureWtf2SelectTestingModule([MultiSelect])));
    ...
    it('should be able to select multiple values', fakeAsync(() => {
      ...
      const options = overlayContainerElement.querySelectorAll('wtf2-option') as
    ...
    it('should be able to set the selected value by taking an array', fakeAsync(() => {
      ...
      const optionNodes = overlayContainerElement.querySelectorAll('wtf2-option') as
          NodeListOf<HTMLElement>;

      const optionInstances = testInstance.options.toArray();

      expect(optionNodes[0].classList).toContain('wtf2-selected');
      expect(optionNodes[5].classList).toContain('wtf2-selected');
    ...
    it('should override the previously-selected value when setting an array', fakeAsync(() => {
      ...
      expect(options[0].classList).toContain('wtf2-selected');

      testInstance.control.setValue(['eggs-5']);
      fixture.detectChanges();

      expect(options[0].classList).not.toContain('wtf2-selected');
      expect(options[5].classList).toContain('wtf2-selected');
    }));
    ...
    it('should throw an exception when trying to set a non-array value', fakeAsync(() => {
      ...
      }).toThrowError(wrappedErrorMessage(getWtf2SelectNonArrayValueError()));
    }));

    it('should throw an exception when trying to change multiple mode after init', fakeAsync(() => {
      expect(() => {
        testInstance.select.multiple = false;
      }).toThrowError(wrappedErrorMessage(getWtf2SelectDynamicMultipleError()));
    }));
...
@Component({
  ...
  template: `
    ...
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [formControl]="control" [required]="isRequired"
        ...
        <wtf2-option *ngFor="let food of foods" [value]="food.value" [disabled]="food.disabled">
          {{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
...
class BasicSelect {
  ...
  @ViewChild(Wtf2Select, {static: true}) select: Wtf2Select;
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" ngModel [disabled]="isDisabled">
        <wtf2-option *ngFor="let food of foods"
...
class NgModelSelect {
  ...
  @ViewChild(Wtf2Select, {static: false}) select: Wtf2Select;
  @ViewChildren(Wtf2Option) options: QueryList<Wtf2Option>;
}
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="First">
        <wtf2-option value="one">one</wtf2-option>
        <wtf2-option value="two">two</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
    <wtf2-form-field>
      <wtf2-select placeholder="Second">
        <wtf2-option value="three">three</wtf2-option>
        <wtf2-option value="four">four</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
...
@Component({
  ...
  template: `
    <div *ngIf="isShowing">
      <wtf2-form-field>
        <wtf2-select placeholder="Food I want to eat right now" [formControl]="control">
          <wtf2-option *ngFor="let food of foods" [value]="food.value">
            {{ food.viewValue }}
          </wtf2-option>
        </wtf2-select>
      </wtf2-form-field>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select (selectionChange)="changeListener($event)">
        <wtf2-option *ngFor="let food of foods" [value]="food">{{ food }}</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
class SelectWithChangeEvent {
  ...
  changeListener = jasmine.createSpy('Wtf2Select change listener');
}
...
@Component({
  ...
  template: `<wtf2-form-field><wtf2-select></wtf2-select></wtf2-form-field>`,
  providers: [{
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select [(ngModel)]="value"></wtf2-select>
    </wtf2-form-field>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [formControl]="control">
        <wtf2-option *ngFor="let food of foods" [value]="food.value">
          {{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select multiple placeholder="Food" [formControl]="control"
...
class MultiSelect {
  ...
  @ViewChild(Wtf2Select, {static: false}) select: Wtf2Select;
  @ViewChildren(Wtf2Option) options: QueryList<Wtf2Option>;
  sortComparator: (a: Wtf2Option, b: Wtf2Option, options: Wtf2Option[]) => number;
}

@Component({
  selector: 'select-with-plain-tabindex',
  template: `<wtf2-form-field><wtf2-select tabindex="5"></wtf2-select></wtf2-form-field>`
})
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select #select="wtf2Select"></wtf2-select>
    </wtf2-form-field>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select [style.display]="isVisible ? 'block' : 'none'">
        <wtf2-option value="value">There are no other options</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
...
@Component({
  ...
  template: `
    <wtf2-form-field [color]="theme">
      <wtf2-select placeholder="Food">
        <wtf2-option value="steak-0">Steak</wtf2-option>
        <wtf2-option value="pizza-1">Pizza</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-select [formControl]="control">
        <wtf2-option *ngFor="let food of foods"
                    [value]="food.value">{{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Pokemon" [formControl]="control">
        <wtf2-optgroup *ngFor="let group of pokemonTypes" [label]="group.name"
          [disabled]="group.disabled">
          <wtf2-option *ngFor="let pokemon of group.pokemon" [value]="pokemon.value">
            {{ pokemon.viewValue }}
          </wtf2-option>
        </wtf2-optgroup>
        <wtf2-option value="mime-11">Mr. Mime</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
      ...
      <wtf2-select placeholder="Pokemon" [formControl]="control">
        <wtf2-optgroup *ngFor="let group of pokemonTypes" [label]="group.name">
          <ng-container *ngFor="let pokemon of group.pokemon">
            <wtf2-option [value]="pokemon.value">{{ pokemon.viewValue }}</wtf2-option>
          </ng-container>
        </wtf2-optgroup>
      </wtf2-select>
    </wtf2-form-field>
...
@Component({
  template: `
    <form [formGroup]="formGroup">
      <wtf2-form-field>
        <wtf2-select placeholder="Food" formControlName="food">
          <wtf2-option *ngFor="let option of options" [value]="option.value">
            {{option.viewValue}}
          </wtf2-option>
        </wtf2-select>
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [(value)]="selectedFood">
        <wtf2-option *ngFor="let food of foods" [value]="food.value">
          {{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [(value)]="selectedFoods" multiple>
        <wtf2-option *ngFor="let food of foods" [value]="food.value">
          {{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [formControl]="control" #select="wtf2Select">
        <wtf2-select-trigger>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select [ngModel]="selectedFood" (ngModelChange)="setFoodByCopy($event)"
                 [compareWith]="comparator">
        <wtf2-option *ngFor="let food of foods" [value]="food">{{ food.viewValue }}</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
...
@Component({
  template: `
    <wtf2-select placeholder="Food" [formControl]="control" [errorStateMatcher]="errorStateMatcher">
      <wtf2-option *ngFor="let food of foods" [value]="food.value">
        {{ food.viewValue }}
      </wtf2-option>
    </wtf2-select>
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [(ngModel)]="selectedFoods">
        <wtf2-option *ngFor="let food of foods"
                    [value]="food.value">{{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-select placeholder="Food" [formControl]="control" disableOptionCentering>
        <wtf2-option *ngFor="let food of foods" [value]="food.value">
          {{ food.viewValue }}
        </wtf2-option>
      </wtf2-select>
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-label>Select a thing</wtf2-label>

      <wtf2-select [placeholder]="placeholder">
        <wtf2-option value="thing">A thing</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
...
@Component({
  template: `
    <wtf2-form-field appearance="fill">
      <wtf2-label>Select something</wtf2-label>
      <wtf2-select *ngIf="showSelect">
        <wtf2-option value="1">One</wtf2-option>
      </wtf2-select>
    </wtf2-form-field>
  `
})
