...
import {Wtf2GridList, Wtf2GridListModule} from './index';
import {Wtf2GridTile, Wtf2GridTileText} from './grid-tile';
import {Directionality} from '@angular/cdk/bidi';


describe('Wtf2GridList', () => {
  function createComponent<T>(componentType: Type<T>): ComponentFixture<T> {
    TestBed.configureTestingModule({
      imports: [Wtf2GridListModule],
  ...
  it('should not throw when setting the `rowHeight` programwtf2ically before init', () => {
    const fixture = createComponent(GridListWithUnspecifiedRowHeight);
    const gridList = fixture.debugElement.query(By.directive(Wtf2GridList));
  ...
  it('should preserve value when zero is set as row height', () => {
    const fixture = createComponent(GridListWithUnspecifiedRowHeight);
    const gridList = fixture.debugElement.query(By.directive(Wtf2GridList)).componentInstance;
  ...
  it('should default to 1:1 row height if undefined ', () => {
    const fixture = createComponent(GridListWithUnspecifiedRowHeight);
    fixture.detectChanges();
    const tile = fixture.debugElement.query(By.directive(Wtf2GridTile));
  ...
  it('should default gutter size to 1px', () => {
    ...
    const tiles = fixture.debugElement.queryAll(By.css('wtf2-grid-tile'));
  ...
  it('should lay out the tiles correctly for a nested grid list', () => {
    ...
    const innerTiles = fixture.debugElement.queryAll(
        By.css('wtf2-grid-tile wtf2-grid-list wtf2-grid-tile'));
  ...
  it('should set the correct list height in ratio mode', () => {
    ...
    const list = fixture.debugElement.query(By.directive(Wtf2GridList));
  ...
  it('should add not add any classes to footers without lines', () => {
    ...
    const footer = fixture.debugElement.query(By.directive(Wtf2GridTileText));
    expect(footer.nativeElement.classList.contains('wtf2-2-line')).toBe(false);
  });
  ...
  it('should add class to footers with two lines', () => {
    ...
    const footer = fixture.debugElement.query(By.directive(Wtf2GridTileText));
    expect(footer.nativeElement.classList.contains('wtf2-2-line')).toBe(true);
  });
  ...
  it('should not use calc() that evaluates to 0', () => {
    ...
    const firstTile = fixture.debugElement.query(By.directive(Wtf2GridTile)).nativeElement;
  ...
  it('should default to LTR if empty directionality is given', () => {
    ...
    const tile: HTMLElement = fixture.debugElement.query(By.css('wtf2-grid-tile')).nativeElement;
    fixture.detectChanges();
...
@Component({template: '<wtf2-grid-list></wtf2-grid-list>'})
class GridListWithoutCols { }

@Component({template: '<wtf2-grid-list cols="4" rowHeight="4:3:2"></wtf2-grid-list>'})
class GridListWithInvalidRowHeightRatio { }

@Component({template:
    '<wtf2-grid-list cols="4"><wtf2-grid-tile colspan="5"></wtf2-grid-tile></wtf2-grid-list>'})
class GridListWithTooWideColspan { }

@Component({template: '<wtf2-grid-list [cols]="cols"></wtf2-grid-list>'})
class GridListWithDynamicCols {
  @ViewChild(Wtf2GridList, {static: false}) gridList: Wtf2GridList;
  cols = 2;
}

@Component({template: `
    <div style="width:200px">
      <wtf2-grid-list cols="1">
        <wtf2-grid-tile></wtf2-grid-tile>
      </wtf2-grid-list>
    </div>`})
...
@Component({template: `
    <div style="width:400px">
      <wtf2-grid-list cols="1" [rowHeight]="rowHeight">
        <wtf2-grid-tile></wtf2-grid-tile>
      </wtf2-grid-list>
    </div>`})
...
@Component({template: `
    <wtf2-grid-list cols="1" rowHeight="fit" [style.height]="totalHeight">
      <wtf2-grid-tile></wtf2-grid-tile>
      <wtf2-grid-tile></wtf2-grid-tile>
    </wtf2-grid-list>`})
...
@Component({template: `
    <wtf2-grid-list cols="4" [rowHeight]="rowHeight">
      <wtf2-grid-tile></wtf2-grid-tile>
    </wtf2-grid-list>`})
...
@Component({template: `
    <wtf2-grid-list cols="4" rowHeight="100">
      <wtf2-grid-tile></wtf2-grid-tile>
    </wtf2-grid-list>`})
...
@Component({template: `
    <div style="width:200px">
      <wtf2-grid-list cols="2" rowHeight="100px">
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
      </wtf2-grid-list>
...
@Component({template: `
    <div style="width:200px">
      <wtf2-grid-list cols="2" gutterSize="2px" rowHeight="100px">
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
      </wtf2-grid-list>
...
@Component({template: `
    <div style="width:200px">
      <wtf2-grid-list cols="2" gutterSize="2" rowHeight="100px">
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
      </wtf2-grid-list>
...
@Component({template: `
    <div style="width:400px">
      <wtf2-grid-list cols="1" rowHeight="4:1">
        <wtf2-grid-tile></wtf2-grid-tile>
        <wtf2-grid-tile></wtf2-grid-tile>
      </wtf2-grid-list>
    </div>`})
...
@Component({template: `
    <wtf2-grid-list cols="1" rowHeight="100px">
      <wtf2-grid-tile></wtf2-grid-tile>
      <wtf2-grid-tile></wtf2-grid-tile>
    </wtf2-grid-list>`})
...
@Component({template: `
    <div style="width:400px">
      <wtf2-grid-list cols="4">
        <wtf2-grid-tile [colspan]="colspan"></wtf2-grid-tile>
      </wtf2-grid-list>
    </div>`})
...
@Component({template: `
    <wtf2-grid-list cols="1" rowHeight="100px">
      <wtf2-grid-tile [rowspan]="rowspan"></wtf2-grid-tile>
    </wtf2-grid-list>`})
...
@Component({template: `
    <div style="width:400px">
      <wtf2-grid-list cols="4" rowHeight="100px">
        <wtf2-grid-tile *ngFor="let tile of tiles" [colspan]="tile.cols" [rowspan]="tile.rows"
...
@Component({template: `
  <div style="width:100px">
    <wtf2-grid-list [cols]="10" gutterSize="0px" rowHeight="10px">
      <wtf2-grid-tile [colspan]="4" [rowspan]="4"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="2" [rowspan]="2"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="4" [rowspan]="4"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="4" [rowspan]="4"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="4" [rowspan]="4"></wtf2-grid-tile>
    </wtf2-grid-list>
...
@Component({template: `
  <div style="width:100px">
    <wtf2-grid-list [cols]="10" gutterSize="0px" rowHeight="10px">
      <wtf2-grid-tile [colspan]="4" [rowspan]="4"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="2" [rowspan]="4"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="4" [rowspan]="4"></wtf2-grid-tile>
      <wtf2-grid-tile [colspan]="1" [rowspan]="2"></wtf2-grid-tile>
    </wtf2-grid-list>
  </div>`})
...
@Component({template: `
    <wtf2-grid-list cols="1">
      <wtf2-grid-tile>
        <wtf2-grid-tile-footer>
          <h3 wtf2-line>First line</h3>
          <span wtf2-line>Second line</span>
        </wtf2-grid-tile-footer>
      </wtf2-grid-tile>
    </wtf2-grid-list>`})
...
@Component({template: `
  <wtf2-grid-list cols="5">
    <wtf2-grid-tile [rowspan]="1" [colspan]="3">1</wtf2-grid-tile>
    <wtf2-grid-tile [rowspan]="2" [colspan]="2">2</wtf2-grid-tile>
    <wtf2-grid-tile [rowspan]="1" [colspan]="2">3</wtf2-grid-tile>
    <wtf2-grid-tile [rowspan]="2" [colspan]="2">4</wtf2-grid-tile>
  </wtf2-grid-list>
`})
class GridListWithoutMatchingGap { }

@Component({
  template: `<wtf2-grid-list cols="1"><wtf2-grid-tile>Hello</wtf2-grid-tile></wtf2-grid-list>`,
