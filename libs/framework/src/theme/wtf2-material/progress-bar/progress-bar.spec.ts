...
import {Wtf2ProgressBarModule, WTF2_PROGRESS_BAR_LOCATION} from './index';
import {Wtf2ProgressBar} from './progress-bar';


describe('Wtf2ProgressBar', () => {
  let fakePath: string;
  ...
  function createComponent<T>(componentType: Type<T>,
    ...
    TestBed.configureTestingModule({
      imports: imports || [Wtf2ProgressBarModule],
      declarations: [componentType],
      providers: [{
        provide: WTF2_PROGRESS_BAR_LOCATION,
  ...
  describe('with animation', () => {
    describe('basic progress-bar', () => {
      it('should apply a mode of "determinate" if no mode is provided.', () => {
        ...
        const progressElement = fixture.debugElement.query(By.css('wtf2-progress-bar'));
    ...
    describe('animation trigger on determinate setting', () => {
      ...
      let progressComponent: Wtf2ProgressBar;
      ...
      beforeEach(() => {
        ...
        primaryValueBar = progressElement.query(By.css('.wtf2-progress-bar-primary'));
      });
  ...
  describe('With NoopAnimations', () => {
    ...
    beforeEach(async(() => {
      fixture = createComponent(BasicProgressBar, [Wtf2ProgressBarModule, NoopAnimationsModule]);
      const progressElement = fixture.debugElement.query(By.css('wtf2-progress-bar'));
      progressComponent = progressElement.componentInstance;
      primaryValueBar = progressElement.query(By.css('.wtf2-progress-bar-primary'));
    }));
...
@Component({template: '<wtf2-progress-bar></wtf2-progress-bar>'})
class BasicProgressBar { }

@Component({template: '<wtf2-progress-bar mode="buffer"></wtf2-progress-bar>'})
