...
import {Wtf2SlideToggle, Wtf2SlideToggleChange, Wtf2SlideToggleModule} from './index';
import {WTF2_SLIDE_TOGGLE_DEFAULT_OPTIONS} from './slide-toggle-config';

describe('Wtf2SlideToggle without forms', () => {
  ...
  beforeEach(fakeAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [Wtf2SlideToggleModule, BidiModule],
      declarations: [
        SlideToggleBasic,
  ...
  describe('basic behavior', () => {
    ...
    let slideToggle: Wtf2SlideToggle;
    ...
    beforeEach(fakeAsync(() => {
      ...
      const slideToggleDebug = fixture.debugElement.query(By.css('wtf2-slide-toggle'));
    ...
    it('should apply class based on color attribute', () => {
      ...
      expect(slideToggleElement.classList).toContain('wtf2-primary');

      testComponent.slideColor = 'accent';
      fixture.detectChanges();

      expect(slideToggleElement.classList).toContain('wtf2-accent');
    });
    ...
    it('should set the toggle to checked on click', () => {
      ...
      expect(inputElement.getAttribute('aria-checked')).toBe('false');
      expect(slideToggleElement.classList).not.toContain('wtf2-checked');

      labelElement.click();
      fixture.detectChanges();

      expect(slideToggleElement.classList).toContain('wtf2-checked');
    ...
    it('should add a suffix to the inputs id', () => {
      ...
      expect(inputElement.id).toMatch(/wtf2-slide-toggle-\d+-input/);
    });
    ...
    it('should set a element class if labelPosition is set to before', () => {
      expect(slideToggleElement.classList).not.toContain('wtf2-slide-toggle-label-before');

      testComponent.labelPosition = 'before';
      fixture.detectChanges();

      expect(slideToggleElement.classList).toContain('wtf2-slide-toggle-label-before');
    });

    it('should show ripples on label mousedown', () => {
      const rippleSelector = '.wtf2-ripple-element:not(.wtf2-slide-toggle-persistent-ripple)';
  ...
  describe('custom template', () => {
    ...
    it('should be able to set the tabindex via the native attribute', fakeAsync(() => {
      ...
      const slideToggle = fixture.debugElement
        .query(By.directive(Wtf2SlideToggle)).componentInstance as Wtf2SlideToggle;
    ...
    it('should set the tabindex of the host element to -1', fakeAsync(() => {
      ...
      const slideToggle = fixture.debugElement.query(By.directive(Wtf2SlideToggle)).nativeElement;
  ...
  describe('custom action configuration', () => {
      ...
      TestBed
        ...
        .configureTestingModule({
          ...
          providers: [
            ...
            {provide: WTF2_SLIDE_TOGGLE_DEFAULT_OPTIONS, useValue: {disableToggleValue: true}},
          ]
        });
      const fixture = TestBed.createComponent(SlideToggleBasic);
      fixture.detectChanges();
    ...
    it('should not change value on dragging when drag action is noop', fakeAsync(() => {
      TestBed
        ...
        .configureTestingModule({
          ...
          providers: [
            ...
            {provide: WTF2_SLIDE_TOGGLE_DEFAULT_OPTIONS, useValue: {disableDragValue: true}},
          ]
        });
      const fixture = TestBed.createComponent(SlideToggleBasic);
      fixture.detectChanges();
      ...
      const thumbContainerDebug = slideToggleDebug
        .query(By.css('.wtf2-slide-toggle-thumb-container'));
      ...
      expect(slideThumbContainer.classList).toContain('wtf2-dragging');
      ...
      expect(slideToggle.checked).toBe(false, 'Expect slide toggle value not changed');
      expect(slideThumbContainer.classList).not.toContain('wtf2-dragging');
  ...
  describe('without label', () => {
    ...
    beforeEach(() => {
      ...
      const slideToggleDebugEl = fixture.debugElement.query(By.directive(Wtf2SlideToggle));

      testComponent = fixture.componentInstance;
      slideToggleBarElement = slideToggleDebugEl
          .query(By.css('.wtf2-slide-toggle-bar')).nativeElement;
    });
    ...
    it('should remove margin for slide-toggle without a label', () => {
      ...
      expect(slideToggleBarElement.classList)
        .toContain('wtf2-slide-toggle-bar-no-side-margin');
    });
    ...
    it('should not remove margin if initial label is set through binding', fakeAsync(() => {
      ...
      expect(slideToggleBarElement.classList)
        .not.toContain('wtf2-slide-toggle-bar-no-side-margin');
    }));
...
describe('Wtf2SlideToggle with forms', () => {

  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2SlideToggleModule, FormsModule, ReactiveFormsModule],
      declarations: [
        SlideToggleWithForm,
  ...
  describe('using ngModel', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      const slideToggleDebug = fixture.debugElement.query(By.directive(Wtf2SlideToggle));
    ...
    it('should update the model programwtf2ically', fakeAsync(() => {
      expect(slideToggleElement.classList).not.toContain('wtf2-checked');
    ...
    it('should not set the control to touched when changing the state programwtf2ically',
        fakeAsync(() => {
    ...
    it('should update checked state on click if control is checked initially', fakeAsync(() => {
      fixture = TestBed.createComponent(SlideToggleWithModel);
      slideToggle = fixture.debugElement.query(By.directive(Wtf2SlideToggle)).componentInstance;
      labelElement = fixture.debugElement.query(By.css('label')).nativeElement;
    ...
    it('should be pristine if initial value is set from NgModel', fakeAsync(() => {
      ...
      const debugElement = fixture.debugElement.query(By.directive(Wtf2SlideToggle));
    ...
    it('should set the model value when toggling via the `toggle` method', fakeAsync(() => {
      ...
      fixture.debugElement.query(By.directive(Wtf2SlideToggle)).componentInstance.toggle();
      fixture.detectChanges();
      flushMicrotasks();
...
@Component({
  template: `
    <wtf2-slide-toggle [dir]="direction" [required]="isRequired"
                     [disabled]="isDisabled"
                     [color]="slideColor"
                     [id]="slideId"
...
class SlideToggleBasic {
  ...
  lastEvent: Wtf2SlideToggleChange;
  ...
  onSlideChange = (event: Wtf2SlideToggleChange) => this.lastEvent = event;
...
@Component({
  template: `
    <form ngNativeValidate (ngSubmit)="isSubmitted = true">
      <wtf2-slide-toggle name="slide" ngModel [required]="isRequired">Required</wtf2-slide-toggle>
...
@Component({
  template: `<wtf2-slide-toggle [(ngModel)]="modelValue"></wtf2-slide-toggle>`
})
...
@Component({
  template: `
    <wtf2-slide-toggle [formControl]="formControl">
      <span>Test Slide Toggle</span>
    </wtf2-slide-toggle>`,
})
...
@Component({template: `<wtf2-slide-toggle tabindex="5" [disabled]="disabled"></wtf2-slide-toggle>`})
class SlideToggleWithTabindexAttr {
  disabled = false;
}

@Component({
  template: `<wtf2-slide-toggle>{{label}}</wtf2-slide-toggle>`
})
...
@Component({
  template: `<wtf2-slide-toggle [(ngModel)]="checked" (change)="onChange()"></wtf2-slide-toggle>`
})
...
@Component({
  template: `<wtf2-slide-toggle><some-text></some-text></wtf2-slide-toggle>`
})
