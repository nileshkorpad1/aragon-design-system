...
import {WTF2_BOTTOM_SHEET_DEFAULT_OPTIONS, Wtf2BottomSheet} from './bottom-sheet';
...
describe('Wtf2BottomSheet', () => {
  let bottomSheet: Wtf2BottomSheet;
  ...
  beforeEach(fakeAsync(() => {
    TestBed
      .configureTestingModule({
        imports: [Wtf2BottomSheetModule, BottomSheetTestModule],
        providers: [{provide: Location, useClass: SpyLocation}]
      })
      .compileComponents();
  }));

  beforeEach(inject([Wtf2BottomSheet, OverlayContainer, ViewportRuler, Location],
    (bs: Wtf2BottomSheet, oc: OverlayContainer, vr: ViewportRuler, l: Location) => {
      bottomSheet = bs;
      overlayContainer = oc;
      viewportRuler = vr;
  ...
  it('should position the bottom sheet at the bottom center of the screen', () => {
    ...
    const containerElement = overlayContainerElement.querySelector('wtf2-bottom-sheet-container')!;
  ...
  it('should close a bottom sheet via the escape key', fakeAsync(() => {
    ...
    expect(overlayContainerElement.querySelector('wtf2-bottom-sheet-container')).toBeNull();
  ...
  it('should not close a bottom sheet via the escape key with a modifier', fakeAsync(() => {
    ...
    expect(overlayContainerElement.querySelector('wtf2-bottom-sheet-container')).toBeTruthy();
  ...
  it('should close when clicking on the overlay backdrop', fakeAsync(() => {
    ...
    expect(overlayContainerElement.querySelector('wtf2-bottom-sheet-container')).toBeFalsy();
  }));
  ...
  it('should emit the keyboardEvent stream when key events target the overlay', fakeAsync(() => {
    ...
    const backdrop = overlayContainerElement.querySelector('.cdk-overlay-backdrop') as HTMLElement;
    const container =
        overlayContainerElement.querySelector('wtf2-bottom-sheet-container') as HTMLElement;
  ...
  it('should be able to set a custom aria-label', () => {
    ...
    const container = overlayContainerElement.querySelector('wtf2-bottom-sheet-container')!;
  ...
  it('should open a new bottom sheet after dismissing a previous sheet', fakeAsync(() => {
    let config: Wtf2BottomSheetConfig = {viewContainerRef: testViewContainerRef};
    let bottomSheetRef: Wtf2BottomSheetRef<any> = bottomSheet.open(PizzaMsg, config);
  ...
  it('should remove bottom sheet if another is shown while its still aniwtf2ing open',
    fakeAsync(() => {
      bottomSheet.open(PizzaMsg);
      viewContainerFixture.detectChanges();
  ...
  describe('focus management', () => {
    ...
    it('should focus the bottom sheet container by default', fakeAsync(() => {
      ...
      expect(document.activeElement!.tagName).toBe('wtf2-BOTTOM-SHEET-CONTAINER',
...
describe('Wtf2BottomSheet with parent Wtf2BottomSheet', () => {
  let parentBottomSheet: Wtf2BottomSheet;
  let childBottomSheet: Wtf2BottomSheet;
  let overlayContainer: OverlayContainer;
  let overlayContainerElement: HTMLElement;
  let fixture: ComponentFixture<ComponentThatProvidesWtf2BottomSheet>;

  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [Wtf2BottomSheetModule, BottomSheetTestModule, NoopAnimationsModule],
      declarations: [ComponentThatProvidesWtf2BottomSheet],
    }).compileComponents();
  }));

  beforeEach(inject([Wtf2BottomSheet, OverlayContainer],
    (bs: Wtf2BottomSheet, oc: OverlayContainer) => {
    parentBottomSheet = bs;
    overlayContainer = oc;
    overlayContainerElement = oc.getContainerElement();
    fixture = TestBed.createComponent(ComponentThatProvidesWtf2BottomSheet);
...
describe('Wtf2BottomSheet with default options', () => {
  let bottomSheet: Wtf2BottomSheet;
  let overlayContainer: OverlayContainer;
  let overlayContainerElement: HTMLElement;
  ...
  beforeEach(fakeAsync(() => {
    const defaultConfig: Wtf2BottomSheetConfig = {
      hasBackdrop: false,
      disableClose: true,
      autoFocus: false
    };
    ...
    TestBed.configureTestingModule({
      imports: [Wtf2BottomSheetModule, BottomSheetTestModule],
      providers: [
        {provide: WTF2_BOTTOM_SHEET_DEFAULT_OPTIONS, useValue: defaultConfig},
      ],
    });
  ...
  beforeEach(inject([Wtf2BottomSheet, OverlayContainer],
    (b: Wtf2BottomSheet, oc: OverlayContainer) => {
      bottomSheet = b;
      overlayContainer = oc;
      overlayContainerElement = oc.getContainerElement();
    }));
...
class ComponentWithTemplateRef {
  localValue: string;
  bottomSheetRef: Wtf2BottomSheetRef<any>;

  @ViewChild(TemplateRef, {static: false}) templateRef: TemplateRef<any>;

  setRef(bottomSheetRef: Wtf2BottomSheetRef<any>): string {
...
class PizzaMsg {
  constructor(public bottomSheetRef: Wtf2BottomSheetRef<PizzaMsg>,
...
@Component({
  template: '',
  providers: [Wtf2BottomSheet]
})
class ComponentThatProvidesWtf2BottomSheet {
  constructor(public bottomSheet: Wtf2BottomSheet) {}
}
...
@NgModule({
  imports: [Wtf2BottomSheetModule, NoopAnimationsModule],
