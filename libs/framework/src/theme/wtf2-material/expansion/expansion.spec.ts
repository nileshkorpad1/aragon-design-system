...
describe('Wtf2ExpansionPanel', () => {
  ...
  it('should expand and collapse the panel', fakeAsync(() => {
    ...
    const headerEl = fixture.nativeElement.querySelector('.wtf2-expansion-panel-header');
    fixture.detectChanges();

    expect(headerEl.classList).not.toContain('wtf2-expanded');

    fixture.componentInstance.expanded = true;
    fixture.detectChanges();
    flush();

    expect(headerEl.classList).toContain('wtf2-expanded');
  }));
  ...
  it('should be able to render panel content lazily', fakeAsync(() => {
    ...
    const content = fixture.debugElement.query(
      By.css('.wtf2-expansion-panel-content')).nativeElement;
    fixture.detectChanges();
  ...
  it('should create a unique panel id for each panel', () => {
    ...
    const headerElOne = fixtureOne.nativeElement.querySelector('.wtf2-expansion-panel-header');
    const fixtureTwo = TestBed.createComponent(PanelWithContent);
    const headerElTwo = fixtureTwo.nativeElement.querySelector('.wtf2-expansion-panel-header');
  ...
  it('should set `aria-labelledby` of the content to the header id', () => {
    const fixture = TestBed.createComponent(PanelWithContent);
    const headerEl = fixture.nativeElement.querySelector('.wtf2-expansion-panel-header');
    const contentEl = fixture.nativeElement.querySelector('.wtf2-expansion-panel-content');
  ...
  it('should restore focus to header if focused element is inside panel on close', fakeAsync(() => {
    ...
    const button = fixture.debugElement.query(By.css('button')).nativeElement;
    const header = fixture.debugElement.query(By.css('wtf2-expansion-panel-header')).nativeElement;
  ...
  it('should not override the panel margin if it is not inside an accordion', fakeAsync(() => {
    ...
    const panel = fixture.debugElement.query(By.css('wtf2-expansion-panel'));
  ...
  it('should be able to hide the toggle', () => {
    ...
    expect(header.querySelector('.wtf2-expansion-indicator'))
  ...
  it('should update the indicator rotation when the expanded state is toggled programwtf2ically',
    fakeAsync(() => {
      const fixture = TestBed.createComponent(PanelWithContent);
      ...
      const arrow = fixture.debugElement.query(By.css('.wtf2-expansion-indicator')).nativeElement;
  ...
  it('should be able to set the default options through the injection token', () => {
    TestBed
      ...
      .configureTestingModule({
        imports: [Wtf2ExpansionModule, NoopAnimationsModule],
        declarations: [PanelWithTwoWayBinding],
        providers: [{
          provide: WTF2_EXPANSION_PANEL_DEFAULT_OPTIONS,
          useValue: {
            hideToggle: true,
            expandedHeight: '10px',
    ...
    const header = fixture.debugElement.query(By.directive(Wtf2ExpansionPanelHeader));
  ...
  describe('disabled state', () => {
    ...
    beforeEach(() => {
      ...
      fixture.detectChanges();
      panel = fixture.debugElement.query(By.css('wtf2-expansion-panel')).nativeElement;
      header = fixture.debugElement.query(By.css('wtf2-expansion-panel-header')).nativeElement;
    });
    ...
    it('should toggle the expansion indicator', () => {
      expect(panel.querySelector('.wtf2-expansion-indicator')).toBeTruthy();

      fixture.componentInstance.disabled = true;
      fixture.detectChanges();

      expect(panel.querySelector('.wtf2-expansion-indicator')).toBeFalsy();
    });
    ...
    it('should not be able to toggle the panel via a user action if disabled', () => {
      ...
      expect(header.classList).not.toContain('wtf2-expanded');
    ...
    it('should be able to toggle a disabled expansion panel programwtf2ically', () => {
      expect(fixture.componentInstance.panel.expanded).toBe(false);
      expect(header.classList).not.toContain('wtf2-expanded');
      ...
      expect(header.classList).toContain('wtf2-expanded');
    });
...
@Component({
  template: `
  <wtf2-expansion-panel [expanded]="expanded"
                      [hideToggle]="hideToggle"
                      [disabled]="disabled"
                      (opened)="openCallback()"
                      (closed)="closeCallback()">
    <wtf2-expansion-panel-header>Panel Title</wtf2-expansion-panel-header>
    <p>Some content</p>
...
class PanelWithContent {
  ...
  @ViewChild(Wtf2ExpansionPanel, {static: false}) panel: Wtf2ExpansionPanel;
}
...
@Component({
  template: `
  <wtf2-expansion-panel [expanded]="true">
    <wtf2-expansion-panel-header>Panel Title</wtf2-expansion-panel-header>
