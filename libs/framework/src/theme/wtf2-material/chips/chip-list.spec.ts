...
import {Wtf2Chip} from './chip';
import {Wtf2ChipInputEvent} from './chip-input';
import {Wtf2ChipEvent, Wtf2ChipList, Wtf2ChipRemove, Wtf2ChipsModule} from './index';


describe('Wtf2ChipList', () => {
  let fixture: ComponentFixture<any>;
  let chipListDebugElement: DebugElement;
  let chipListNativeElement: HTMLElement;
  let chipListInstance: Wtf2ChipList;
  let testComponent: StandardChipList;
  let chips: QueryList<Wtf2Chip>;
  let manager: FocusKeyManager<Wtf2Chip>;
  let zone: MockNgZone;
  ...
  describe('StandardChipList', () => {
    describe('basic behaviors', () => {
      ...
      it('should add the `wtf2-chip-list` class', () => {
        expect(chipListNativeElement.classList).toContain('wtf2-chip-list');
      });
    ...
    describe('with selected chips', () => {
      beforeEach(() => {
        ...
        fixture.detectChanges();
        chipListDebugElement = fixture.debugElement.query(By.directive(Wtf2ChipList));
    ...
    describe('keyboard behavior', () => {
      describe('LTR (default)', () => {
        ...
        it('should focus previous item when press LEFT ARROW', () => {
          let nativeChips = chipListNativeElement.querySelectorAll('wtf2-chip');
        ...
        it('should focus the first item when pressing HOME', () => {
          const nativeChips = chipListNativeElement.querySelectorAll('wtf2-chip');
  ...
  describe('FormFieldChipList', () => {
    ...
    describe('keyboard behavior', () => {
      ...
      it('should maintain focus if the active chip is deleted', () => {
        const secondChip = fixture.nativeElement.querySelectorAll('.wtf2-chip')[1];
  ...
  describe('with chip remove', () => {
    ...
    beforeEach(() => {
      ...
      chipList = fixture.debugElement.query(By.directive(Wtf2ChipList)).componentInstance;
      chipRemoveDebugElements = fixture.debugElement.queryAll(By.directive(Wtf2ChipRemove));
  ...
  describe('selection logic', () => {
    ...
    beforeEach(() => {
      ...
      nativeChips = fixture.debugElement.queryAll(By.css('wtf2-chip'))
  ...
  describe('forms integration', () => {
    ...
    describe('single selection', () => {
      ...
      it('should set the control to touched when the chip list is touched', () => {
        ...
        const nativeChipList = fixture.debugElement.query(By.css('.wtf2-chip-list')).nativeElement;
      ...
      it('should be able to programwtf2ically select a falsy option', () => {
        fixture.destroy();
        TestBed.resetTestingModule();
      ...
      it('should not focus the active chip when the value is set programwtf2ically', () => {
      ...
      it('should blur the form field when the active chip is blurred', fakeAsync(() => {
        ...
        expect(formField.classList).toContain('wtf2-focused');
        ...
        expect(formField.classList).not.toContain('wtf2-focused');
      }));
    });
  ...
  describe('chip list with chip input', () => {
    ...
    it('should keep focus on the input after adding the first chip', fakeAsync(() => {
      ...
      const chipEls = Array.from<HTMLElement>(
          fixture.nativeElement.querySelectorAll('.wtf2-chip')).reverse();
  ...
  describe('error messages', () => {
    ...
    beforeEach(() => {
      ...
      chipListEl = fixture.debugElement.query(By.css('wtf2-chip-list')).nativeElement;
    });
...
@Component({
  template: `
    <wtf2-chip-list [tabIndex]="tabIndex" [selectable]="selectable">
      <wtf2-chip *ngFor="let i of chips" (select)="chipSelect(i)" (deselect)="chipDeselect(i)">
        {{name}} {{i + 1}}
      </wtf2-chip>
    </wtf2-chip-list>`
})
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-label>Add a chip</wtf2-label>
      <wtf2-chip-list #chipList>
        <wtf2-chip *ngFor="let chip of chips" (removed)="remove(chip)">{{chip}}</wtf2-chip>
      </wtf2-chip-list>
      <input name="test" [wtf2ChipInputFor]="chipList"/>
    </wtf2-form-field>
  `
})
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-chip-list placeholder="Food" [formControl]="control" [required]="isRequired"
        [tabIndex]="tabIndexOverride" [selectable]="selectable">
        <wtf2-chip *ngFor="let food of foods" [value]="food.value" [disabled]="food.disabled">
          {{ food.viewValue }}
        </wtf2-chip>
      </wtf2-chip-list>
    </wtf2-form-field>
...
class BasicChipList {
  ...
  @ViewChild(Wtf2ChipList, {static: false}) chipList: Wtf2ChipList;
  @ViewChildren(Wtf2Chip) chips: QueryList<Wtf2Chip>;
}
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-chip-list [multiple]="true" placeholder="Food" [formControl]="control"
        [required]="isRequired"
        [tabIndex]="tabIndexOverride" [selectable]="selectable">
        <wtf2-chip *ngFor="let food of foods" [value]="food.value" [disabled]="food.disabled">
          {{ food.viewValue }}
...
@Component({
  ...
  template: `
    <wtf2-form-field>
      <wtf2-chip-list [multiple]="true"
                    placeholder="Food" [formControl]="control" [required]="isRequired" #chipList1>
        <wtf2-chip *ngFor="let food of foods" [value]="food.value" (removed)="remove(food)">
          {{ food.viewValue }}
        </wtf2-chip>
      </wtf2-chip-list>
      <input placeholder="New food..."
          [wtf2ChipInputFor]="chipList1"
          [wtf2ChipInputSeparatorKeyCodes]="separatorKeyCodes"
...
class InputChipList {
  ...
  add(event: Wtf2ChipInputEvent): void {
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-chip-list [formControl]="control">
        <wtf2-chip *ngFor="let food of foods" [value]="food.value">{{ food.viewValue }}</wtf2-chip>
      </wtf2-chip-list>
    </wtf2-form-field>
  `
})
...
@Component({
  template: `
    <wtf2-chip-list>
        <wtf2-chip *ngFor="let food of foods" [value]="food.value" [selected]="food.selected">
            {{ food.viewValue }}
        </wtf2-chip>
    </wtf2-chip-list>
  `
...
<form #form="ngForm" novalidate>
  <wtf2-form-field>
    <wtf2-chip-list [formControl]="formControl">
      <wtf2-chip *ngFor="let food of foods" [value]="food.value" [selected]="food.selected">
      {{food.viewValue}}
      </wtf2-chip>
    </wtf2-chip-list>
    <wtf2-hint>Please select a chip, or type to add a new chip</wtf2-hint>
    <wtf2-error>Should have value</wtf2-error>
  </wtf2-form-field>
</form>
  `
})
...
@Component({
  template: `
    <wtf2-chip-list>
      <wtf2-chip *ngFor="let i of numbers" (removed)="remove(i)">{{i}}</wtf2-chip>
    </wtf2-chip-list>`,
  animations: [
...
@Component({
  template: `
    <wtf2-form-field>
      <wtf2-chip-list>
        <wtf2-chip [value]="i" (removed)="removeChip($event)" *ngFor="let i of chips">
          Chip {{i + 1}}
          <span wtf2ChipRemove>Remove</span>
        </wtf2-chip>
      </wtf2-chip-list>
    </wtf2-form-field>
  `
...
class ChipListWithRemove {
  ...
  removeChip(event: Wtf2ChipEvent) {
