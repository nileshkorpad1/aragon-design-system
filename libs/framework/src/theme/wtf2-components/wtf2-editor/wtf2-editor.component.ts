...
import { Wtf2EditorConfig, wtf2EditorConfig } from './config';
...
@Component({
  selector: 'wtf2-editor',
  templateUrl: './wtf2-editor.component.html',
  styleUrls: ['./wtf2-editor.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => Wtf2EditorComponent),
      multi: true
    }
  ]
})
export class Wtf2EditorComponent
  ...
  @Input() id = '';
  @Input() config: Wtf2EditorConfig = wtf2EditorConfig;
  ...
  editorToolbar: Wtf2EditorToolbarComponent;
  ...
  constructor(
    ...
    private editorService: Wtf2EditorService,
  ...
  ngOnInit() {
    ...
    this.editorToolbar.fonts = this.config.fonts
      ? this.config.fonts
      : wtf2EditorConfig.fonts;
    this.editorToolbar.toolbar = this.config.toolbar
      ? this.config.toolbar
      : wtf2EditorConfig.toolbar;
