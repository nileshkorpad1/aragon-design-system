...
export class Wtf2SidebarComponent implements OnInit, OnDestroy {
     ...
     * @param {Wtf2MatchMediaService} _wtf2MatchMediaService
     * @param {Wtf2SidebarService} _wtf2SidebarService
     * @param {ObservableMedia} _mediaObserver
    ...
    ngOnInit(): void {
        ...
        this._wtf2ConfigService.config
            ...
            .subscribe((config) => {
                this._wtf2Config = config;
            });

        // Register the sidebar
        this._wtf2SidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void {
        ...
        this._wtf2SidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add('wtf2-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if (this.invisibleOverlay) {
            this._backdrop.classList.add('wtf2-sidebar-overlay-invisible');
        }
