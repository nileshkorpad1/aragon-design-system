...
@Component({
  ...
  template: `
    <wtf2-datatable-row-detail id="t1"></wtf2-datatable-row-detail>
    <wtf2-datatable-row-detail id="t2">
      <ng-template wtf2-datatable-row-detail-template></ng-template>
    </wtf2-datatable-row-detail>
  `,
})
