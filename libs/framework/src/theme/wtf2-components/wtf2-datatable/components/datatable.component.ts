import {
    ...
    ChangeDetectionStrategy, ChangeDetectorRef, SkipSelf, OnDestroy, AfterContentInit,
} from '@angular/core';
...
@Component({
  ...
  host: {
    class: 'wtf2-datatable'
  }
})
export class DatatableComponent
  implements OnInit, DoCheck, OnDestroy, AfterViewInit, AfterContentInit {
  /**
