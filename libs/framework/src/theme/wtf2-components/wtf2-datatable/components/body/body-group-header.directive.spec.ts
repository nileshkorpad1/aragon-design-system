...
@Component({
  ...
  template: `
    <wtf2DatatableGroupHeader id="t1"></wtf2DatatableGroupHeader>
    <wtf2DatatableGroupHeader id="t2">
      <ng-template wtf2-datatable-group-header-template></ng-template>
    </wtf2DatatableGroupHeader>
  `,
})
