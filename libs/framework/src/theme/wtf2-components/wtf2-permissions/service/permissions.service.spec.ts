...
describe('Permissions Service', () => {
    let localService: Wtf2PermissionsService;
    beforeEach(() => {
    ...
    beforeEach(inject([Wtf2PermissionsService], (service: Wtf2PermissionsService) => {
...
describe('Permissions Service model', () => {
    it('should create role mode', () => {
        const permission = new Wtf2Permission('permission', () => true);
