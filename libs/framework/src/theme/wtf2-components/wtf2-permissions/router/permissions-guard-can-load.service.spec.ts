...
import { Wtf2PermissionsGuard } from './permissions-guard.service';
...
describe('Permissions guard only', () => {
    ...
    let permissionGuard: Wtf2PermissionsGuard;
    let route;
    let fakeRouter;
    beforeEach(() => {
    ...
    beforeEach(inject([Wtf2PermissionsService, Wtf2RolesService], (service: Wtf2PermissionsService, rolesService: Wtf2RolesService) => {
        fakeRouter = <any>{navigate: () => {}};
        spyOn(fakeRouter, 'navigate');

        service.addPermission('ADMIN');
        permissionGuard = new Wtf2PermissionsGuard(service, rolesService, fakeRouter as Router);
    }));
...
describe('Permissions guard Except and only together with isolation in root', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [Wtf2PermissionsModule.forRoot({permissionsIsolate: true, rolesIsolate: true})],
        });
    });
    beforeEach(inject([Wtf2PermissionsService, Wtf2RolesService], (service: Wtf2PermissionsService, rolesService: Wtf2RolesService) => {
        fakeRouter = <any>{navigate: () => {}};
...
describe('Permissions guard use only dynamically', () => {
    ...
    beforeEach(inject([Wtf2PermissionsService, Wtf2RolesService], (service: Wtf2PermissionsService, rolesService: Wtf2RolesService, router: Router) => {
        fakeRouter = <any>{navigate: () => {}};
