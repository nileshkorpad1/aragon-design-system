...
import { Wtf2Colors } from '../../wtf2-colors';

@Component({
    selector     : 'wtf2-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : wtf2Animations,
    encapsulation: ViewEncapsulation.None,
})
export class Wtf2MaterialColorPickerComponent implements OnChanges
{
    colors: any;
    hues: string[];
    selectedColor: any;
    ...
    updateSelectedColor(): void
    {
        setTimeout(() => {
            ...
            if ( this.selectedPalette !== '' && this.selectedHue !== '' ) {
                this.selectedBg = Wtf2Colors.getColor(this.selectedPalette)[this.selectedHue];
                this.selectedFg = Wtf2Colors.getColor(this.selectedPalette).contrast[this.selectedHue];
                this.selectedClass = 'wtf2-' + this.selectedPalette + '-' + this.selectedHue + '-bg';
            } else {
                this.selectedBg = '';
                this.selectedFg = '';
            }
